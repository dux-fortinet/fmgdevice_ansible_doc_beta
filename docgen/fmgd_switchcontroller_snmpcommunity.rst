:source: fmgd_switchcontroller_snmpcommunity.py

:orphan:

.. _fmgd_switchcontroller_snmpcommunity:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_snmpcommunity</span> - Configure FortiSwitch SNMP v1/v2c communities globally. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch SNMP v1/v2c communities globally.
        fortinet.fortimanager.fmgd_switchcontroller_snmpcommunity:
