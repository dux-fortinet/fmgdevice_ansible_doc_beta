:source: fmgd_router_ospf_redistribute.py

:orphan:

.. _fmgd_router_ospf_redistribute:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ospf_redistribute</span> - Redistribute configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Redistribute configuration.
        fortinet.fortimanager.fmgd_router_ospf_redistribute:
