:source: fmgd_report_layout_page_footer_footeritem.py

:orphan:

.. _fmgd_report_layout_page_footer_footeritem:
...
.. raw:: html
 ...
 <li><span class="li-head">report_layout_page_footer_footeritem</span> - Configure report footer item. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure report footer item.
        fortinet.fortimanager.fmgd_report_layout_page_footer_footeritem:
