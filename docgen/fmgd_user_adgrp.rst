...
.. raw:: html
 ...
 <li><span class="li-head">server_name</span> <b>(Alias name: server-name)</b>  Fsso agent name. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FSSO groups.
        fortinet.fmgdevice.fmgd_user_adgrp:
