:source: fmgd_user_krbkeytab.py

:orphan:

.. _fmgd_user_krbkeytab:
...
.. raw:: html
 ...
 <li><span class="li-head">principal</span> Kerberos service principal. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure Kerberos keytab entries.
        fortinet.fmgdevice.fmgd_user_krbkeytab:
