:source: fmgd_webcache_useragent.py

:orphan:

.. _fmgd_webcache_useragent:
...
.. raw:: html
 ...
 <li><span class="li-head">webcache_useragent</span> - Device vdom webcache user agent <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">name</span> Name of the user agent item. <span class="li-normal">type: str</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code>, <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">value</span> User agent of the url. <span class="li-normal">type: str</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom webcache user agent
        fortinet.fmgdevice.fmgd_webcache_useragent:
