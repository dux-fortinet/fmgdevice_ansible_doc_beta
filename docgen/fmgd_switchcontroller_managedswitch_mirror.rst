:source: fmgd_switchcontroller_managedswitch_mirror.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_mirror:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit FortiSwitch packet mirror.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_mirror:
