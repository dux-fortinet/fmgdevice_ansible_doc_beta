:source: fmgd_wireless_wtpprofile_denymaclist.py

:orphan:

.. _fmgd_wireless_wtpprofile_denymaclist:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_wtpprofile_denymaclist</span> - List of MAC addresses that are denied access to this WTP, FortiAP, or AP. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: List of MAC addresses that are denied access to this WTP, FortiAP, or AP.
        fortinet.fortimanager.fmgd_wireless_wtpprofile_denymaclist:
