:source: fmgd_sshfilter_profile.py

:orphan:

.. _fmgd_sshfilter_profile:
...
.. raw:: html
 ...
 <li><span class="li-head">sshfilter_profile</span> - Configure SSH filter profile. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure SSH filter profile.
        fortinet.fmgdevice.fmgd_sshfilter_profile:
