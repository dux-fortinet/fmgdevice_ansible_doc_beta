:source: fmgd_switchcontroller_managedswitch_systemdhcpserver_options.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_systemdhcpserver_options:
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: DHCP options.
        fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_systemdhcpserver_options:
