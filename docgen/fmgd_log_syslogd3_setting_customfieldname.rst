:source: fmgd_log_syslogd3_setting_customfieldname.py

:orphan:

.. _fmgd_log_syslogd3_setting_customfieldname:
...
.. raw:: html
 ...
 <li><span class="li-head">log_syslogd3_setting_customfieldname</span> - Custom field name for CEF format logging. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
