:source: fmgd_log_syslogd3_overridefilter.py

:orphan:

.. _fmgd_log_syslogd3_overridefilter:
...
.. raw:: html
 ...
 <li><span class="li-head">log_syslogd3_overridefilter</span> - Override filters for remote system server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Override filters for remote system server.
        fortinet.fortimanager.fmgd_log_syslogd3_overridefilter:
