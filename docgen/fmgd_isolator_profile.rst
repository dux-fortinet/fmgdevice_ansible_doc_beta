:source: fmgd_isolator_profile.py

:orphan:

.. _fmgd_isolator_profile:
...
.. raw:: html
 ...
 <li><span class="li-head">isolator_profile</span> - Device vdom isolator profile <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom isolator profile
        fortinet.fmgdevice.fmgd_isolator_profile:
