:source: fmgd_system_automationaction_formdata.py

:orphan:

.. _fmgd_system_automationaction_formdata:
...
.. raw:: html
 ...
 <li><span class="li-head">automation_action</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">system_automationaction_formdata</span> - Form data parts for content type multipart/form-data. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Form data parts for content type multipart/form-data.
        fortinet.fmgdevice.fmgd_system_automationaction_formdata:
          ...
          system_automationaction_formdata:
