:source: fmgd_switchcontroller_snmptrapthreshold.py

:orphan:

.. _fmgd_switchcontroller_snmptrapthreshold:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_snmptrapthreshold</span> - Configure FortiSwitch SNMP trap threshold values globally. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch SNMP trap threshold values globally.
        fortinet.fortimanager.fmgd_switchcontroller_snmptrapthreshold:
