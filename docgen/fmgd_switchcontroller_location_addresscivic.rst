:source: fmgd_switchcontroller_location_addresscivic.py

:orphan:

.. _fmgd_switchcontroller_location_addresscivic:
...
.. raw:: html
 ...
 <li><span class="li-head">location</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">switchcontroller_location_addresscivic</span> - Configure location civic address. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure location civic address.
        fortinet.fortimanager.fmgd_switchcontroller_location_addresscivic:
