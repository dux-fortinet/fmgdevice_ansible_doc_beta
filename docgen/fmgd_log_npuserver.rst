:source: fmgd_log_npuserver.py

:orphan:

.. _fmgd_log_npuserver:

fmgd_log_npuserver -- Configure all the log servers and create the server groups.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">sw_log_flags</span> <b>(Alias name: sw-log-flags)</b>  Set flags for software logging via driver. <span class="li-normal">type: str</span> <span class="li-normal">choices: [tcp-udp-only, enable-all-log, disable-all-log]</span> 
 ...
 <ul class="ul-self">
 <li><span class="li-head">dest_port</span> <b>(Alias name: dest-port)</b>  Set the dest port (1-65535) for the log packet. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">source_port</span> <b>(Alias name: source-port)</b>  Set the source port (1-65535) for the log packet. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">vdom</span> Interface connected to the log server is in this virtual domain (vdom). <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure all the log servers and create the server groups.
        fortinet.fmgdevice.fmgd_log_npuserver:
