:source: fmgd_switchcontroller_managedswitch_igmpsnooping.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_igmpsnooping:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch IGMP snooping global settings.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_igmpsnooping:
