:source: fmgd_firewall_ippoolgrp.py

:orphan:

.. _fmgd_firewall_ippoolgrp:

fmgd_firewall_ippoolgrp -- Configure IPv4 pool groups.
++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">member</span> Member ip pool of the group (they must have same attributes except public/client ranges). <span class="li-normal">type: list</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code>, <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">name</span> Ippool group name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv4 pool groups.
        fortinet.fmgdevice.fmgd_firewall_ippoolgrp:
