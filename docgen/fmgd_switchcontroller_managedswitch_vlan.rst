:source: fmgd_switchcontroller_managedswitch_vlan.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_vlan:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure VLAN assignment priority.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_vlan:
