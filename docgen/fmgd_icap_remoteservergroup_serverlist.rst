:source: fmgd_icap_remoteservergroup_serverlist.py

:orphan:

.. _fmgd_icap_remoteservergroup_serverlist:
...
.. raw:: html
 ...
 <li><span class="li-head">icap_remoteservergroup_serverlist</span> - Device vdom icap remote server group server list <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom icap remote server group server list
        fortinet.fmgdevice.fmgd_icap_remoteservergroup_serverlist:
