:source: fmgd_system_lldp_networkpolicy_videoconferencing.py

:orphan:

.. _fmgd_system_lldp_networkpolicy_videoconferencing:
...
.. raw:: html
 ...
 <li><span class="li-head">system_lldp_networkpolicy_videoconferencing</span> - Video Conferencing. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Video Conferencing.
        fortinet.fortimanager.fmgd_system_lldp_networkpolicy_videoconferencing:
