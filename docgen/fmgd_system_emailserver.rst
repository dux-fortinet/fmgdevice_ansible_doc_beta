:source: fmgd_system_emailserver.py

:orphan:

.. _fmgd_system_emailserver:
...
.. raw:: html
 ...
 <li><span class="li-head">system_emailserver</span> - Configure the email server used by the FortiGate various things. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
