:source: fmgd_firewall_proxyaddrgrp6_tagging.py

:orphan:

.. _fmgd_firewall_proxyaddrgrp6_tagging:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_proxyaddrgrp6_tagging</span> - Device vdom firewall proxy addrgrp6 tagging <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom firewall proxy addrgrp6 tagging
        fortinet.fmgdevice.fmgd_firewall_proxyaddrgrp6_tagging:
