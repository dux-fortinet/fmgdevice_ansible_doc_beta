:source: fmgd_wireless_mpskprofile_mpskgroup.py

:orphan:

.. _fmgd_wireless_mpskprofile_mpskgroup:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_mpskprofile_mpskgroup</span> - List of multiple PSK groups. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: List of multiple PSK groups.
        fortinet.fortimanager.fmgd_wireless_mpskprofile_mpskgroup:
