:source: fmgd_vpnsslweb_usergroupbookmark.py

:orphan:

.. _fmgd_vpnsslweb_usergroupbookmark:
...
.. raw:: html
 ...
 <li><span class="li-head">vpnsslweb_usergroupbookmark</span> - Configure SSL-VPN user group bookmark. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure SSL-VPN user group bookmark.
        fortinet.fortimanager.fmgd_vpnsslweb_usergroupbookmark:
