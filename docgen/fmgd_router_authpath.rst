:source: fmgd_router_authpath.py

:orphan:

.. _fmgd_router_authpath:
...
.. raw:: html
 ...
 <li><span class="li-head">router_authpath</span> - Configure authentication based routing. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">device</span> Outgoing interface. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">name</span> Name of the entry. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure authentication based routing.
        fortinet.fortimanager.fmgd_router_authpath:
