:source: fmgd_switchcontroller_igmpsnooping.py

:orphan:

.. _fmgd_switchcontroller_igmpsnooping:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_igmpsnooping</span> - Configure FortiSwitch IGMP snooping global settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">aging_time</span> <b>(Alias name: aging-time)</b>  Maximum number of seconds to retain a multicast snooping entry for which no packets have been seen (15 - 3600 sec, default = 300). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">query_interval</span> <b>(Alias name: query-interval)</b>  Maximum time after which igmp query will be sent (10 - 1200 sec, default = 125). <span class="li-normal">type: int</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch IGMP snooping global settings.
        fortinet.fortimanager.fmgd_switchcontroller_igmpsnooping:
