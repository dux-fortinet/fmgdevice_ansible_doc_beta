:source: fmgd_log_syslogd4_overridesetting_customfieldname.py

:orphan:

.. _fmgd_log_syslogd4_overridesetting_customfieldname:
...
.. raw:: html
 ...
 <li><span class="li-head">log_syslogd4_overridesetting_customfieldname</span> - Custom field name for CEF format logging. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Custom field name for CEF format logging.
        fortinet.fortimanager.fmgd_log_syslogd4_overridesetting_customfieldname:
