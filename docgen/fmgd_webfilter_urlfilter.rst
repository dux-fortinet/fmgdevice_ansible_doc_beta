:source: fmgd_webfilter_urlfilter.py

:orphan:

.. _fmgd_webfilter_urlfilter:
...
.. raw:: html
 ...
 <li><span class="li-head">exempt</span> If action is set to exempt, select the security profile operations that exempt urls skip. <span class="li-normal">type: list</span> <span class="li-normal">choices: [av, web-content, activex-java-cookie, dlp, fortiguard, all, pass, range-block, antiphish]</span> 
 ...
 <li><span class="li-head">web_proxy_profile</span> <b>(Alias name: web-proxy-profile)</b>  Web proxy profile. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">include_subdomains</span> <b>(Alias name: include-subdomains)</b>  Include subdomains. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure URL filter lists.
        fortinet.fmgdevice.fmgd_webfilter_urlfilter:
          ...
          webfilter_urlfilter:
            ...
            #     url: <string>
            #     web_proxy_profile: <list or string>
            #     comment: <string>
