:source: fmgd_user_quarantine_targets.py

:orphan:

.. _fmgd_user_quarantine_targets:
...
.. raw:: html
 ...
 <li><span class="li-head">user_quarantine_targets</span> - Quarantine entry to hold multiple MACs. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Quarantine entry to hold multiple MACs.
        fortinet.fortimanager.fmgd_user_quarantine_targets:
