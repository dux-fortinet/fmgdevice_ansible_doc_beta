:source: fmgd_switchcontroller_virtualportpool.py

:orphan:

.. _fmgd_switchcontroller_virtualportpool:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_virtualportpool</span> - Configure virtual pool. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">name</span> Virtual switch pool name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure virtual pool.
        fortinet.fortimanager.fmgd_switchcontroller_virtualportpool:
