:source: fmgd_switchcontroller_fortilinksettings_nacports.py

:orphan:

.. _fmgd_switchcontroller_fortilinksettings_nacports:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: NAC specific configuration.
        fortinet.fortimanager.fmgd_switchcontroller_fortilinksettings_nacports:
