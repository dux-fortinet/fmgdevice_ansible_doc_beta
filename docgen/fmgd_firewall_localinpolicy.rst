:source: fmgd_firewall_localinpolicy.py

:orphan:

.. _fmgd_firewall_localinpolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_localinpolicy</span> - Configure user defined IPv4 local-in policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure user defined IPv4 local-in policies.
        fortinet.fmgdevice.fmgd_firewall_localinpolicy:
