:source: fmgd_router_bgp_neighborrange6.py

:orphan:

.. _fmgd_router_bgp_neighborrange6:
...
.. raw:: html
 ...
 <li><span class="li-head">router_bgp_neighborrange6</span> - BGP IPv6 neighbor range table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: BGP IPv6 neighbor range table.
        fortinet.fortimanager.fmgd_router_bgp_neighborrange6:
