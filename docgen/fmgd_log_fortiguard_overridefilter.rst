:source: fmgd_log_fortiguard_overridefilter.py

:orphan:

.. _fmgd_log_fortiguard_overridefilter:
...
.. raw:: html
 ...
 <li><span class="li-head">log_fortiguard_overridefilter</span> - Override filters for FortiCloud. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Override filters for FortiCloud.
        fortinet.fortimanager.fmgd_log_fortiguard_overridefilter:
