:source: fmgd_system_externalresource.py

:orphan:

.. _fmgd_system_externalresource:
...
.. raw:: html
 ...
 <li><span class="li-head">type</span> User resource type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [category, address, domain, malware, url, data, mac-address, generic-address]</span> 
 ...
 <li><span class="li-head">user_agent</span> <b>(Alias name: user-agent)</b>  Http user-agent header (default = curl/7. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure external resource.
        fortinet.fmgdevice.fmgd_system_externalresource:
          ...
          system_externalresource:
            ...
            # resource: <string>
            # server_identity_check: <value in [none, basic, full]>
            # source_ip: <string>
            # status: <value in [disable, enable]>
            # type: <value in [category, address, domain, ...]>
            # update_method: <value in [feed, push]>
            # user_agent: <string>
            # username: <string>
            # uuid: <string>
