:source: fmgd_switchcontroller_managedswitch_snmptrapthreshold.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_snmptrapthreshold:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit Simple Network Management Protocol
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_snmptrapthreshold:
