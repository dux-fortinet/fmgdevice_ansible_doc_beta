:source: fmgd_system_virtualwanlink.py

:orphan:

.. _fmgd_system_virtualwanlink:
...
.. raw:: html
 ...
 <li><span class="li-head">system_virtualwanlink</span> - Configure redundant internet connections using SD-WAN <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">member</span> Member sequence number. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">internet_service_id</span> <b>(Alias name: internet-service-id)</b>  Internet service id list. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure redundant internet connections using SD-WAN
        fortinet.fortimanager.fmgd_system_virtualwanlink:
