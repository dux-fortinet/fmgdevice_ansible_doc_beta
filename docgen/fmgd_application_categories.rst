:source: fmgd_application_categories.py

:orphan:

.. _fmgd_application_categories:
...
.. raw:: html
 ...
 <li><span class="li-head">application_categories</span> - Device application categories <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device application categories
        fortinet.fmgdevice.fmgd_application_categories:
