:source: fmgd_firewall_service_group.py

:orphan:

.. _fmgd_firewall_service_group:
...
.. raw:: html
 ...
 <li><span class="li-head">name</span> Service group name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure service groups.
        fortinet.fmgdevice.fmgd_firewall_service_group:
