:source: fmgd_system_nethsm_slots.py

:orphan:

.. _fmgd_system_nethsm_slots:
...
.. raw:: html
 ...
 <li><span class="li-head">system_nethsm_slots</span> - Device system nethsm slots <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device system nethsm slots
        fortinet.fmgdevice.fmgd_system_nethsm_slots:
