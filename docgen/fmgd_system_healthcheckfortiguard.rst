:source: fmgd_system_healthcheckfortiguard.py

:orphan:

.. _fmgd_system_healthcheckfortiguard:
...
.. raw:: html
 ...
 <li><span class="li-head">system_healthcheckfortiguard</span> - SD-WAN status checking or health checking. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">name</span> Status check or predefined health-check targets name. <span class="li-normal">type: str</span>
