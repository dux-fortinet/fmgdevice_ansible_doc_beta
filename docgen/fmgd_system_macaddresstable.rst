:source: fmgd_system_macaddresstable.py

:orphan:

.. _fmgd_system_macaddresstable:
...
.. raw:: html
 ...
 <li><span class="li-head">system_macaddresstable</span> - Configure MAC address tables. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">reply_substitute</span> <b>(Alias name: reply-substitute)</b>  New mac for reply traffic. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure MAC address tables.
        fortinet.fortimanager.fmgd_system_macaddresstable:
