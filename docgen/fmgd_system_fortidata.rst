:source: fmgd_system_fortidata.py

:orphan:

.. _fmgd_system_fortidata:
...
.. raw:: html
 ...
 <li><span class="li-head">system_fortidata</span> - Configure FortiData. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">source_ip</span> <b>(Alias name: source-ip)</b>  Source ipv4 address used to communicate with fortidata. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiData.
        fortinet.fmgdevice.fmgd_system_fortidata:
