:source: fmgd_system_geoipcountry.py

:orphan:

.. _fmgd_system_geoipcountry:
...
.. raw:: html
 ...
 <li><span class="li-head">system_geoipcountry</span> - Device system geoip country <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device system geoip country
        fortinet.fmgdevice.fmgd_system_geoipcountry:
