:source: fmgd_system_sdnconnector_externalaccountlist.py

:orphan:

.. _fmgd_system_sdnconnector_externalaccountlist:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure AWS external account list.
        fortinet.fmgdevice.fmgd_system_sdnconnector_externalaccountlist:
