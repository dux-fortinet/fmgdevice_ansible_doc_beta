:source: fmgd_switchcontroller_managedswitch_ipsourceguard_bindingentry.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_ipsourceguard_bindingentry:
...
.. raw:: html
 ...
 <li><span class="li-head">ip-source-guard</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: IP and MAC address configuration.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_ipsourceguard_bindingentry:
