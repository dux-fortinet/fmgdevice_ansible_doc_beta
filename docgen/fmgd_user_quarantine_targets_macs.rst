:source: fmgd_user_quarantine_targets_macs.py

:orphan:

.. _fmgd_user_quarantine_targets_macs:
...
.. raw:: html
 ...
 <li><span class="li-head">targets</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">user_quarantine_targets_macs</span> - Quarantine MACs. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Quarantine MACs.
        fortinet.fortimanager.fmgd_user_quarantine_targets_macs:
