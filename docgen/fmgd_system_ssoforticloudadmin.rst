:source: fmgd_system_ssoforticloudadmin.py

:orphan:

.. _fmgd_system_ssoforticloudadmin:
...
.. raw:: html
 ...
 <li><span class="li-head">system_ssoforticloudadmin</span> - Configure FortiCloud SSO admin users. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
