:source: fmgd_system_npu_npqueues.py

:orphan:

.. _fmgd_system_npu_npqueues:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_npqueues</span> - Configure queue assignment on NP7LITE. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure queue assignment on NP7LITE.
        fortinet.fmgdevice.fmgd_system_npu_npqueues:
