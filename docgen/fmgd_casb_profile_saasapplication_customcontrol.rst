:source: fmgd_casb_profile_saasapplication_customcontrol.py

:orphan:

.. _fmgd_casb_profile_saasapplication_customcontrol:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: CASB profile custom control.
        fortinet.fmgdevice.fmgd_casb_profile_saasapplication_customcontrol:
