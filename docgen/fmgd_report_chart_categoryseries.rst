:source: fmgd_report_chart_categoryseries.py

:orphan:

.. _fmgd_report_chart_categoryseries:
...
.. raw:: html
 ...
 <li><span class="li-head">report_chart_categoryseries</span> - Category series of pie chart. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Category series of pie chart.
        fortinet.fortimanager.fmgd_report_chart_categoryseries:
