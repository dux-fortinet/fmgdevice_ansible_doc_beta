:source: fmgd_system_spanport.py

:orphan:

.. _fmgd_system_spanport:
...
.. raw:: html
 ...
 <li><span class="li-head">system_spanport</span> - Device system span port <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">span_dest_port</span> <b>(Alias name: span-dest-port)</b>  Span dest port. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">span_source_port</span> <b>(Alias name: span-source-port)</b>  Span source port. <span class="li-normal">type: list</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device system span port
        fortinet.fmgdevice.fmgd_system_spanport:
