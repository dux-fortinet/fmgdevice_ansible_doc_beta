:source: fmgd_system_dhcp6_server_iprange.py

:orphan:

.. _fmgd_system_dhcp6_server_iprange:
...
.. raw:: html
 ...
 <li><span class="li-head">system_dhcp6_server_iprange</span> - DHCP IP range configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: DHCP IP range configuration.
        fortinet.fortimanager.fmgd_system_dhcp6_server_iprange:
