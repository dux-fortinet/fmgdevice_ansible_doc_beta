:source: fmgd_switchcontroller_managedswitch_stpsettings.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_stpsettings:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit Spanning Tree Protocol
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_stpsettings:
