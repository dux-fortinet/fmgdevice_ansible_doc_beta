:source: fmgd_switchcontroller_managedswitch_systemdhcpserver_iprange.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_systemdhcpserver_iprange:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: DHCP IP range configuration.
        fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_systemdhcpserver_iprange:
