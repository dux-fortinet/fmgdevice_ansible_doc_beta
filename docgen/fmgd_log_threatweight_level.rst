:source: fmgd_log_threatweight_level.py

:orphan:

.. _fmgd_log_threatweight_level:
...
.. raw:: html
 ...
 <li><span class="li-head">log_threatweight_level</span> - Score mapping for threat weight levels. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Score mapping for threat weight levels.
        fortinet.fmgdevice.fmgd_log_threatweight_level:
