:source: fmgd_switchcontroller_location_coordinates.py

:orphan:

.. _fmgd_switchcontroller_location_coordinates:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_location_coordinates</span> - Configure location GPS coordinates. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure location GPS coordinates.
        fortinet.fortimanager.fmgd_switchcontroller_location_coordinates:
