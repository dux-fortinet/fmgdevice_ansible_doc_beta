:source: fmgd_firewall_vip6_dynamicmapping.py

:orphan:

.. _fmgd_firewall_vip6_dynamicmapping:

fmgd_firewall_vip6_dynamicmapping -- Configure virtual IP for IPv6.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">ipv4_mappedip</span> <b>(Alias name: ipv4-mappedip)</b>  Support meta variable <span class="li-normal">type: str</span>
 <a id='label52' href="javascript:ContentClick('label53', 'label52');" onmouseover="ContentPreview('label53');" onmouseout="ContentUnpreview('label53');" title="click to collapse or expand..."> more... </a>
 <div id="label53" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">ipv4_mappedport</span> <b>(Alias name: ipv4-mappedport)</b>  Support meta variable <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure virtual IP for IPv6.
        fortinet.fmgdevice.fmgd_firewall_vip6_dynamicmapping:
          ...
          firewall_vip6_dynamicmapping:
            ...
            # color: <integer>
            # comment: <string>
            # embedded_ipv4_address: <value in [disable, enable]>
            ...
            # nat66: <value in [disable, enable]>
            # ndp_reply: <value in [disable, enable]>
