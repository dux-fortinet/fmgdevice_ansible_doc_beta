:source: fmgd_firewall_internetservicecustom.py

:orphan:

.. _fmgd_firewall_internetservicecustom:
...
.. raw:: html
 ...
 <li><span class="li-head">master_service_id</span> <b>(Alias name: master-service-id)</b>  Internet service id in the internet service database. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure custom Internet Services.
        fortinet.fmgdevice.fmgd_firewall_internetservicecustom:
          ...
          firewall_internetservicecustom:
            ...
            #     protocol: <integer>
            # master_service_id: <list or string>
