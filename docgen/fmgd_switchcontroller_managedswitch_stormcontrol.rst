:source: fmgd_switchcontroller_managedswitch_stormcontrol.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_stormcontrol:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit FortiSwitch storm control for measuring traffic activity using data rates to prevent traffic disruption.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_stormcontrol:
