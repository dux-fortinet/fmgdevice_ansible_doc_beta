:source: fmgd_switchcontroller_stpinstance.py

:orphan:

.. _fmgd_switchcontroller_stpinstance:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_stpinstance</span> - Configure FortiSwitch multiple spanning tree protocol <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">vlan_range</span> <b>(Alias name: vlan-range)</b>  Configure vlan range for stp instance. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch multiple spanning tree protocol
        fortinet.fortimanager.fmgd_switchcontroller_stpinstance:
