:source: fmgd_router_ospf_area_virtuallink_md5keys.py

:orphan:

.. _fmgd_router_ospf_area_virtuallink_md5keys:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ospf_area_virtuallink_md5keys</span> - MD5 key. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: MD5 key.
        fortinet.fortimanager.fmgd_router_ospf_area_virtuallink_md5keys:
