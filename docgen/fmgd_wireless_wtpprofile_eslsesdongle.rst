:source: fmgd_wireless_wtpprofile_eslsesdongle.py

:orphan:

.. _fmgd_wireless_wtpprofile_eslsesdongle:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_wtpprofile_eslsesdongle</span> - ESL SES-imagotag dongle configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: ESL SES-imagotag dongle configuration.
        fortinet.fortimanager.fmgd_wireless_wtpprofile_eslsesdongle:
