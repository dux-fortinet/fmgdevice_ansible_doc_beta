:source: fmgd_webproxy_urllist_entries.py

:orphan:

.. _fmgd_webproxy_urllist_entries:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_urllist_entries</span> - Device vdom web proxy url list entries <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">type</span> Type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [simple, wildcard]</span> 
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy url list entries
        fortinet.fmgdevice.fmgd_webproxy_urllist_entries:
          ...
          webproxy_urllist_entries:
            id: 0 # Required variable, integer
            # status: <value in [disable, enable]>
            # type: <value in [simple, wildcard]>
            # url: <string>
