:source: fmgd_casb_profile_saasapplication_advancedtenantcontrol_attribute.py

:orphan:

.. _fmgd_casb_profile_saasapplication_advancedtenantcontrol_attribute:
...
.. raw:: html
 ...
 <li><span class="li-head">advanced_tenant_control</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: CASB advanced tenant control attribute.
        fortinet.fmgdevice.fmgd_casb_profile_saasapplication_advancedtenantcontrol_attribute:
