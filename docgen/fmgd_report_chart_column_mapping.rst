:source: fmgd_report_chart_column_mapping.py

:orphan:

.. _fmgd_report_chart_column_mapping:
...
.. raw:: html
 ...
 <li><span class="li-head">column</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">report_chart_column_mapping</span> - Show detail in certain display value for certain condition. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Show detail in certain display value for certain condition.
        fortinet.fortimanager.fmgd_report_chart_column_mapping:
