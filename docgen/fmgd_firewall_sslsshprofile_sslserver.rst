:source: fmgd_firewall_sslsshprofile_sslserver.py

:orphan:

.. _fmgd_firewall_sslsshprofile_sslserver:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_sslsshprofile_sslserver</span> - SSL server settings used for client certificate request. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: SSL server settings used for client certificate request.
        fortinet.fmgdevice.fmgd_firewall_sslsshprofile_sslserver:
