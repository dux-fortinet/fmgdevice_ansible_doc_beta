:source: fmgd_firewall_mmsprofile.py

:orphan:

.. _fmgd_firewall_mmsprofile:

fmgd_firewall_mmsprofile -- Configure MMS profiles.
+++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">avnotificationtable</span> Antivirus notification table id. <span class="li-normal">type: list</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code></p>
 </div>
 </li>
 <li><span class="li-head">bwordtable</span> Mms banned word table id. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">carrierendpointbwltable</span> Carrier end point filter table id. <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">action1</span> Action to take when threshold reached. <span class="li-normal">type: list</span> <span class="li-normal">choices: [log, archive, block, archive-first, alert-notif]</span> 
 <a id='label18' href="javascript:ContentClick('label19', 'label18');" onmouseover="ContentPreview('label19');" onmouseout="ContentUnpreview('label19');" title="click to collapse or expand..."> more... </a>
 <div id="label19" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code></p>
 </div>
 </li>
 <li><span class="li-head">action2</span> Action to take when threshold reached. <span class="li-normal">type: list</span> <span class="li-normal">choices: [log, archive, block, archive-first, alert-notif]</span> 
 <a id='label20' href="javascript:ContentClick('label21', 'label20');" onmouseover="ContentPreview('label21');" onmouseout="ContentUnpreview('label21');" title="click to collapse or expand..."> more... </a>
 <div id="label21" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code></p>
 </div>
 </li>
 <li><span class="li-head">action3</span> Action to take when threshold reached. <span class="li-normal">type: list</span> <span class="li-normal">choices: [log, archive, block, archive-first, alert-notif]</span> 
 ...
 <li><span class="li-head">mm1</span> Mm1 options. <span class="li-normal">type: list</span> <span class="li-normal">choices: [avmonitor, oversize, quarantine, scan, bannedword, carrier-endpoint-bwl, remove-blocked, chunkedbypass, clientcomfort, servercomfort, mms-checksum]</span> 
 ...
 <li><span class="li-head">mm1_outbreak_prevention</span> <b>(Alias name: mm1-outbreak-prevention)</b>  Enable virus outbreak prevention service. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disabled, files, full-archive]</span> 
 ...
 <li><span class="li-head">mm3</span> Mm3 options. <span class="li-normal">type: list</span> <span class="li-normal">choices: [avmonitor, oversize, quarantine, scan, bannedword, carrier-endpoint-bwl, remove-blocked, fragmail, splice, mms-checksum]</span> 
 <a id='label104' href="javascript:ContentClick('label105', 'label104');" onmouseover="ContentPreview('label105');" onmouseout="ContentUnpreview('label105');" title="click to collapse or expand..."> more... </a>
 <div id="label105" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code></p>
 </div>
 </li>
 <li><span class="li-head">mm3_outbreak_prevention</span> <b>(Alias name: mm3-outbreak-prevention)</b>  Enable virus outbreak prevention service. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disabled, files, full-archive]</span> 
 ...
 <li><span class="li-head">mm4</span> Mm4 options. <span class="li-normal">type: list</span> <span class="li-normal">choices: [avmonitor, oversize, quarantine, scan, bannedword, carrier-endpoint-bwl, remove-blocked, fragmail, splice, mms-checksum]</span> 
 <a id='label110' href="javascript:ContentClick('label111', 'label110');" onmouseover="ContentPreview('label111');" onmouseout="ContentUnpreview('label111');" title="click to collapse or expand..."> more... </a>
 <div id="label111" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.8 -> v7.4.8</code></p>
 </div>
 </li>
 <li><span class="li-head">mm4_outbreak_prevention</span> <b>(Alias name: mm4-outbreak-prevention)</b>  Enable virus outbreak prevention service. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disabled, files, full-archive]</span> 
 ...
 <li><span class="li-head">mm7</span> Mm7 options. <span class="li-normal">type: list</span> <span class="li-normal">choices: [avmonitor, oversize, quarantine, scan, bannedword, carrier-endpoint-bwl, remove-blocked, chunkedbypass, clientcomfort, servercomfort, mms-checksum]</span> 
 ...
 <li><span class="li-head">mm7_outbreak_prevention</span> <b>(Alias name: mm7-outbreak-prevention)</b>  Enable virus outbreak prevention service. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disabled, files, full-archive]</span> 
 ...
 <li><span class="li-head">mms_checksum_table</span> <b>(Alias name: mms-checksum-table)</b>  Mms content checksum table id. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure MMS profiles.
        fortinet.fmgdevice.fmgd_firewall_mmsprofile:
          ...
          firewall_mmsprofile:
            ...
            # avnotificationtable: <list or string>
            # bwordtable: <list or string>
            # carrier_endpoint_prefix: <value in [disable, enable]>
            # carrier_endpoint_prefix_range_max: <integer>
            # carrier_endpoint_prefix_range_min: <integer>
            # carrier_endpoint_prefix_string: <string>
            # carrierendpointbwltable: <list or string>
            # comment: <string>
            # dupe:
            #   action1:
            #     - "log"
            ...
            #   - "mms-checksum"
            # mm1_addr_hdr: <string>
            # mm1_addr_source: <value in [http-header, cookie]>
            # mm1_convert_hex: <value in [disable, enable]>
            # mm1_outbreak_prevention: <value in [disabled, files, full-archive]>
            # mm1_retr_dupe: <value in [disable, enable]>
            # mm1_retrieve_scan: <value in [disable, enable]>
            ...
            #   - "splice"
            #   - "mms-checksum"
            # mm3_outbreak_prevention: <value in [disabled, files, full-archive]>
            ...
            #   - "splice"
            #   - "mms-checksum"
            # mm4_outbreak_prevention: <value in [disabled, files, full-archive]>
            ...
            #   - "mms-checksum"
            # mm7_addr_hdr: <string>
            # mm7_addr_source: <value in [http-header, cookie]>
            # mm7_convert_hex: <value in [disable, enable]>
            # mm7_outbreak_prevention: <value in [disabled, files, full-archive]>
            # mm7comfortamount: <integer>
            # mm7comfortinterval: <integer>
            # mm7oversizelimit: <integer>
            # mms_antispam_mass_log: <value in [disable, enable]>
            # mms_av_block_log: <value in [disable, enable]>
            # mms_av_oversize_log: <value in [disable, enable]>
            # mms_av_virus_log: <value in [disable, enable]>
            # mms_carrier_endpoint_filter_log: <value in [disable, enable]>
            # mms_checksum_log: <value in [disable, enable]>
            # mms_checksum_table: <list or string>
            # mms_notification_log: <value in [disable, enable]>
            # mms_web_content_log: <value in [disable, enable]>
            ...
            # remove_blocked_const_length: <value in [disable, enable]>
