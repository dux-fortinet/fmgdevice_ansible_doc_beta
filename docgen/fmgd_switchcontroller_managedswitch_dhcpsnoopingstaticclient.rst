:source: fmgd_switchcontroller_managedswitch_dhcpsnoopingstaticclient.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_dhcpsnoopingstaticclient:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch DHCP snooping static clients.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_dhcpsnoopingstaticclient:
