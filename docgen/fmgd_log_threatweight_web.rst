:source: fmgd_log_threatweight_web.py

:orphan:

.. _fmgd_log_threatweight_web:
...
.. raw:: html
 ...
 <li><span class="li-head">log_threatweight_web</span> - Web filtering threat weight settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Web filtering threat weight settings.
        fortinet.fmgdevice.fmgd_log_threatweight_web:
