:source: fmgd_report_layout_bodyitem_list.py

:orphan:

.. _fmgd_report_layout_bodyitem_list:
...
.. raw:: html
 ...
 <li><span class="li-head">report_layout_bodyitem_list</span> - Configure report list item. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure report list item.
        fortinet.fortimanager.fmgd_report_layout_bodyitem_list:
