:source: fmgd_firewall_profileprotocoloptions_imap.py

:orphan:

.. _fmgd_firewall_profileprotocoloptions_imap:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IMAP protocol options.
        fortinet.fmgdevice.fmgd_firewall_profileprotocoloptions_imap:
