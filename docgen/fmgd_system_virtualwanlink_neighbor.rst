:source: fmgd_system_virtualwanlink_neighbor.py

:orphan:

.. _fmgd_system_virtualwanlink_neighbor:
...
.. raw:: html
 ...
 <li><span class="li-head">system_virtualwanlink_neighbor</span> - Create SD-WAN neighbor from BGP neighbor table to control route advertisements according to SLA status. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Create SD-WAN neighbor from BGP neighbor table to control route advertisements according to SLA status.
        fortinet.fortimanager.fmgd_system_virtualwanlink_neighbor:
