:source: fmgd_router_multicast_interface_igmp.py

:orphan:

.. _fmgd_router_multicast_interface_igmp:
...
.. raw:: html
 ...
 <li><span class="li-head">router_multicast_interface_igmp</span> - IGMP configuration options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: IGMP configuration options.
        fortinet.fortimanager.fmgd_router_multicast_interface_igmp:
