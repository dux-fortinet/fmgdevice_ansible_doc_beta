:source: fmgd_switchcontroller_stormcontrol.py

:orphan:

.. _fmgd_switchcontroller_stormcontrol:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_stormcontrol</span> - Configure FortiSwitch storm control. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch storm control.
        fortinet.fortimanager.fmgd_switchcontroller_stormcontrol:
