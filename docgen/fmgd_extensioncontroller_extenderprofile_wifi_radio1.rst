:source: fmgd_extensioncontroller_extenderprofile_wifi_radio1.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_wifi_radio1:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Radio-1 config for Wi-Fi 2.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_wifi_radio1:
