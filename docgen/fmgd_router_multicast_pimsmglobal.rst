:source: fmgd_router_multicast_pimsmglobal.py

:orphan:

.. _fmgd_router_multicast_pimsmglobal:
...
.. raw:: html
 ...
 <li><span class="li-head">router_multicast_pimsmglobal</span> - PIM sparse-mode global settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: PIM sparse-mode global settings.
        fortinet.fortimanager.fmgd_router_multicast_pimsmglobal:
