:source: fmgd_log_threatweight_application.py

:orphan:

.. _fmgd_log_threatweight_application:
...
.. raw:: html
 ...
 <li><span class="li-head">log_threatweight_application</span> - Application-control threat weight settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Application-control threat weight settings.
        fortinet.fmgdevice.fmgd_log_threatweight_application:
