:source: fmgd_firewall_profileprotocoloptions_nntp.py

:orphan:

.. _fmgd_firewall_profileprotocoloptions_nntp:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure NNTP protocol options.
        fortinet.fmgdevice.fmgd_firewall_profileprotocoloptions_nntp:
