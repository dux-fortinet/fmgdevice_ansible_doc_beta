:source: fmgd_dnsfilter_profile_ftgddns_filters.py

:orphan:

.. _fmgd_dnsfilter_profile_ftgddns_filters:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_profile_ftgddns_filters</span> - FortiGuard DNS domain filters. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiGuard DNS domain filters.
        fortinet.fmgdevice.fmgd_dnsfilter_profile_ftgddns_filters:
