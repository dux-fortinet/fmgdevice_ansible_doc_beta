:source: fmgd_switchcontroller_snmpcommunity_hosts.py

:orphan:

.. _fmgd_switchcontroller_snmpcommunity_hosts:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_snmpcommunity_hosts</span> - Configure IPv4 SNMP managers <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv4 SNMP managers
        fortinet.fortimanager.fmgd_switchcontroller_snmpcommunity_hosts:
