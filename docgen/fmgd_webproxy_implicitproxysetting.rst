:source: fmgd_webproxy_implicitproxysetting.py

:orphan:

.. _fmgd_webproxy_implicitproxysetting:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_implicitproxysetting</span> - Device vdom web proxy implicit proxy setting <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">implicit_proxy_rule</span> <b>(Alias name: implicit-proxy-rule)</b>  Implicit proxy rule. <span class="li-normal">type: list</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy implicit proxy setting
        fortinet.fmgdevice.fmgd_webproxy_implicitproxysetting:
          ...
          webproxy_implicitproxysetting:
            name: "your value" # Required variable, string
            # implicit_proxy_rule: <list or string>
