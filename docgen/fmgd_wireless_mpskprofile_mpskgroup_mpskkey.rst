:source: fmgd_wireless_mpskprofile_mpskgroup_mpskkey.py

:orphan:

.. _fmgd_wireless_mpskprofile_mpskgroup_mpskkey:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_mpskprofile_mpskgroup_mpskkey</span> - List of multiple PSK entries. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: List of multiple PSK entries.
        fortinet.fortimanager.fmgd_wireless_mpskprofile_mpskgroup_mpskkey:
