:source: fmgd_extendercontroller_extender_modem2.py

:orphan:

.. _fmgd_extendercontroller_extender_modem2:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration options for modem 2.
        fortinet.fortimanager.fmgd_extendercontroller_extender_modem2:
