:source: fmgd_casb_profile_saasapplication_advancedtenantcontrol.py

:orphan:

.. _fmgd_casb_profile_saasapplication_advancedtenantcontrol:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: CASB profile advanced tenant control.
        fortinet.fmgdevice.fmgd_casb_profile_saasapplication_advancedtenantcontrol:
