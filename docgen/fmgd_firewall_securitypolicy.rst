:source: fmgd_firewall_securitypolicy.py

:orphan:

.. _fmgd_firewall_securitypolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_securitypolicy</span> - When configuring policy within policy package, use <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">virtual_patch_profile</span> <b>(Alias name: virtual-patch-profile)</b>  Name of an existing virtual-patch profile. <span class="li-normal">type: list</span>
 <a id='label164' href="javascript:ContentClick('label165', 'label164');" onmouseover="ContentPreview('label165');" onmouseout="ContentUnpreview('label165');" title="click to collapse or expand..."> more... </a>
 <div id="label165" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">voip_profile</span> <b>(Alias name: voip-profile)</b>  Name of an existing voip (voipd) profile. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: When configuring policy within policy package, use
        fortinet.fmgdevice.fmgd_firewall_securitypolicy:
