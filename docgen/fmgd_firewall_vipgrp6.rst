:source: fmgd_firewall_vipgrp6.py

:orphan:

.. _fmgd_firewall_vipgrp6:
...
.. raw:: html
 ...
 <li><span class="li-head">name</span> Ipv6 vip group name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv6 virtual IP groups.
        fortinet.fmgdevice.fmgd_firewall_vipgrp6:
