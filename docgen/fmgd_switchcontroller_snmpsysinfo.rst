:source: fmgd_switchcontroller_snmpsysinfo.py

:orphan:

.. _fmgd_switchcontroller_snmpsysinfo:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_snmpsysinfo</span> - Configure FortiSwitch SNMP system information globally. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch SNMP system information globally.
        fortinet.fortimanager.fmgd_switchcontroller_snmpsysinfo:
