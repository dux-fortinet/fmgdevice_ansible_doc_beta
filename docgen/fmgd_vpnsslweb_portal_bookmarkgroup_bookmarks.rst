:source: fmgd_vpnsslweb_portal_bookmarkgroup_bookmarks.py

:orphan:

.. _fmgd_vpnsslweb_portal_bookmarkgroup_bookmarks:
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Bookmark table.
        fortinet.fmgdevice.fmgd_vpnsslweb_portal_bookmarkgroup_bookmarks:
