:source: fmgd_filefilter_profile_rules.py

:orphan:

.. _fmgd_filefilter_profile_rules:
...
.. raw:: html
 ...
 <li><span class="li-head">direction</span> Traffic direction (http, ftp, ssh, cifs, and mapi only). <span class="li-normal">type: str</span> <span class="li-normal">choices: [any, incoming, outgoing]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: File filter rules.
        fortinet.fmgdevice.fmgd_filefilter_profile_rules:
