:source: fmgd_casb_useractivity.py

:orphan:

.. _fmgd_casb_useractivity:
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">application</span> Casb saas application name. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure CASB user activity.
        fortinet.fmgdevice.fmgd_casb_useractivity:
