:source: fmgd_switchcontroller_managedswitch_routeoffloadrouter.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_routeoffloadrouter:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure route offload MCLAG IP address.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_routeoffloadrouter:
