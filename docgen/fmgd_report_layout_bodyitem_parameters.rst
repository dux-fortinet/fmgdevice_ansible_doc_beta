:source: fmgd_report_layout_bodyitem_parameters.py

:orphan:

.. _fmgd_report_layout_bodyitem_parameters:
...
.. raw:: html
 ...
 <li><span class="li-head">body-item</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">report_layout_bodyitem_parameters</span> - Parameters. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Parameters.
        fortinet.fortimanager.fmgd_report_layout_bodyitem_parameters:
