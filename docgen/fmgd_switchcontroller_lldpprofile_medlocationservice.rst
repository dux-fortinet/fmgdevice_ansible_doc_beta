:source: fmgd_switchcontroller_lldpprofile_medlocationservice.py

:orphan:

.. _fmgd_switchcontroller_lldpprofile_medlocationservice:
...
.. raw:: html
 ...
 <li><span class="li-head">sys_location_id</span> <b>(Alias name: sys-location-id)</b>  Location service id. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit Media Endpoint Discovery
        fortinet.fortimanager.fmgd_switchcontroller_lldpprofile_medlocationservice:
