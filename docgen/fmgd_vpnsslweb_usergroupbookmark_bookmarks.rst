:source: fmgd_vpnsslweb_usergroupbookmark_bookmarks.py

:orphan:

.. _fmgd_vpnsslweb_usergroupbookmark_bookmarks:
...
.. raw:: html
 ...
 <li><span class="li-head">user-group-bookmark</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">vpnsslweb_usergroupbookmark_bookmarks</span> - Bookmark table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">apptype</span> Application type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [web, ftp, telnet, smb, vnc, rdp, ssh, citrix, portforward, sftp]</span> 
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Bookmark table.
        fortinet.fortimanager.fmgd_vpnsslweb_usergroupbookmark_bookmarks:
