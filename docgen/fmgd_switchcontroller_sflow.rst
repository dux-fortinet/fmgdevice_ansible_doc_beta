:source: fmgd_switchcontroller_sflow.py

:orphan:

.. _fmgd_switchcontroller_sflow:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_sflow</span> - Configure FortiSwitch sFlow. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">collector_port</span> <b>(Alias name: collector-port)</b>  Sflow collector port (0 - 65535). <span class="li-normal">type: int</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch sFlow.
        fortinet.fortimanager.fmgd_switchcontroller_sflow:
