:source: fmgd_switchcontroller_snmpuser.py

:orphan:

.. _fmgd_switchcontroller_snmpuser:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_snmpuser</span> - Configure FortiSwitch SNMP v3 users globally. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch SNMP v3 users globally.
        fortinet.fortimanager.fmgd_switchcontroller_snmpuser:
