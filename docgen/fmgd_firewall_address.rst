:source: fmgd_firewall_address.py

:orphan:

.. _fmgd_firewall_address:
...
.. raw:: html
 ...
 <li><span class="li-head">allow_routing</span> <b>(Alias name: allow-routing)</b>  Enable/disable use of this address in routing configurations. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">associated_interface</span> <b>(Alias name: associated-interface)</b>  Network interface associated with address. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">clearpass_spt</span> <b>(Alias name: clearpass-spt)</b>  Spt (system posture token) value. <span class="li-normal">type: str</span> <span class="li-normal">choices: [unknown, healthy, quarantine, checkup, infected, transient]</span> 
 ...
 <li><span class="li-head">type</span> Type of address. <span class="li-normal">type: str</span> <span class="li-normal">choices: [ipmask, iprange, fqdn, wildcard, geography, dynamic, interface-subnet, fqdn-group, route-tag, mac]</span> 
 ...
 <li><span class="li-head">interface</span> Name of interface whose ip address is to be used. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv4 addresses.
        fortinet.fmgdevice.fmgd_firewall_address:
