:source: fmgd_firewall_address6_list.py

:orphan:

.. _fmgd_firewall_address6_list:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_address6_list</span> - IP address list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: IP address list.
        fortinet.fmgdevice.fmgd_firewall_address6_list:
