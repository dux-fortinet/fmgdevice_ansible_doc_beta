:source: fmgd_extensioncontroller_extenderprofile_cellular_smsnotification.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_cellular_smsnotification:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiExtender cellular SMS notification configuration.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_cellular_smsnotification:
