:source: fmgd_firewall_proxyaddress_tagging.py

:orphan:

.. _fmgd_firewall_proxyaddress_tagging:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Config object tagging.
        fortinet.fmgdevice.fmgd_firewall_proxyaddress_tagging:
