:source: fmgd_switchcontroller_managedswitch_routervrf.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_routervrf:
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure VRF.
        fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_routervrf:
