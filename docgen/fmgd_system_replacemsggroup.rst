:source: fmgd_system_replacemsggroup.py

:orphan:

.. _fmgd_system_replacemsggroup:
...
.. raw:: html
 ...
 <li><span class="li-head">group_type</span> <b>(Alias name: group-type)</b>  Group type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [default, utm, auth, ec]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure replacement message groups.
        fortinet.fmgdevice.fmgd_system_replacemsggroup:
          ...
          system_replacemsggroup:
            ...
            #     header: <value in [none, http, 8bit]>
            #     msg_type: <string>
            # group_type: <value in [default, utm, auth, ...]>
            # http:
            #   - buffer: <string>
            #     format: <value in [none, text, html, ...]>
            #     header: <value in [none, http, 8bit]>
