:source: fmgd_switchcontroller_managedswitch_ipsourceguard.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_ipsourceguard:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: IP source guard.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_ipsourceguard:
