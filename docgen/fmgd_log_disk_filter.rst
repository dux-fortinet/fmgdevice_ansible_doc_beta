:source: fmgd_log_disk_filter.py

:orphan:

.. _fmgd_log_disk_filter:
...
.. raw:: html
 ...
 <li><span class="li-head">log_disk_filter</span> - Configure filters for local disk logging. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure filters for local disk logging.
        fortinet.fortimanager.fmgd_log_disk_filter:
