:source: fmgd_router_ripng_aggregateaddress.py

:orphan:

.. _fmgd_router_ripng_aggregateaddress:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ripng_aggregateaddress</span> - Aggregate address. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Aggregate address.
        fortinet.fortimanager.fmgd_router_ripng_aggregateaddress:
