:source: fmgd_webproxy_implicitproxyrule.py

:orphan:

.. _fmgd_webproxy_implicitproxyrule:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_implicitproxyrule</span> - Device vdom web proxy implicit proxy rule <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">bypass_list</span> <b>(Alias name: bypass-list)</b>  Bypass list. <span class="li-normal">type: list</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">load_balance_method</span> <b>(Alias name: load-balance-method)</b>  Load balance method. <span class="li-normal">type: str</span> <span class="li-normal">choices: [static, round-robin, weighted, first-alive]</span> 
 ...
 <li><span class="li-head">proxy_servers</span> <b>(Alias name: proxy-servers)</b>  Proxy servers. <span class="li-normal">type: list</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy implicit proxy rule
        fortinet.fmgdevice.fmgd_webproxy_implicitproxyrule:
          ...
          webproxy_implicitproxyrule:
            name: "your value" # Required variable, string
            # bypass_list: <list or string>
            # load_balance_method: <value in [static, round-robin, weighted, ...]>
            # proxy_servers:
            #   - id: <integer>
            #     ip: <string>
            #     port: <integer>
