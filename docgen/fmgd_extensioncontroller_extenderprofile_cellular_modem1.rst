:source: fmgd_extensioncontroller_extenderprofile_cellular_modem1.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_cellular_modem1:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration options for modem 1.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_cellular_modem1:
