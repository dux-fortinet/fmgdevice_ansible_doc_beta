:source: fmgd_webfilter_domainlist.py

:orphan:

.. _fmgd_webfilter_domainlist:
...
.. raw:: html
 ...
 <li><span class="li-head">webfilter_domainlist</span> - Device vdom webfilter domain list <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom webfilter domain list
        fortinet.fmgdevice.fmgd_webfilter_domainlist:
