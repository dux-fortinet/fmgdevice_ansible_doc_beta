:source: fmgd_switchcontroller_switchinterfacetag.py

:orphan:

.. _fmgd_switchcontroller_switchinterfacetag:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure switch object tags.
        fortinet.fortimanager.fmgd_switchcontroller_switchinterfacetag:
