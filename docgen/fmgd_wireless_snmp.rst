...
.. raw:: html
 ...
 <li><span class="li-head">wireless_snmp</span> - Configure SNMP. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">community</span> Community. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">engine_id</span> <b>(Alias name: engine-id)</b>  Ac snmp engineid string (maximum 24 characters). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">trap_high_mem_threshold</span> <b>(Alias name: trap-high-mem-threshold)</b>  Memory usage when trap is sent. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">notify_hosts</span> <b>(Alias name: notify-hosts)</b>  Configure snmp user notify hosts. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">status</span> Snmp user enable. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure SNMP.
        fortinet.fortimanager.fmgd_wireless_snmp:
