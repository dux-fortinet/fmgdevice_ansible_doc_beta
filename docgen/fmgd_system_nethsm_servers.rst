:source: fmgd_system_nethsm_servers.py

:orphan:

.. _fmgd_system_nethsm_servers:
...
.. raw:: html
 ...
 <li><span class="li-head">system_nethsm_servers</span> - Device system nethsm servers <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device system nethsm servers
        fortinet.fmgdevice.fmgd_system_nethsm_servers:
