:source: fmgd_system_linkmonitor_serverlist.py

:orphan:

.. _fmgd_system_linkmonitor_serverlist:
...
.. raw:: html
 ...
 <li><span class="li-head">link-monitor</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">system_linkmonitor_serverlist</span> - Servers for link-monitor to monitor. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Servers for link-monitor to monitor.
        fortinet.fortimanager.fmgd_system_linkmonitor_serverlist:
