:source: fmgd_system_sdnconnector_compartmentlist.py

:orphan:

.. _fmgd_system_sdnconnector_compartmentlist:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure OCI compartment list.
        fortinet.fmgdevice.fmgd_system_sdnconnector_compartmentlist:
