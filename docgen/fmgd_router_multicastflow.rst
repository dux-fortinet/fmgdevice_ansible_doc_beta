:source: fmgd_router_multicastflow.py

:orphan:

.. _fmgd_router_multicastflow:
...
.. raw:: html
 ...
 <li><span class="li-head">router_multicastflow</span> - Configure multicast-flow. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">flows</span> Flows. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure multicast-flow.
        fortinet.fortimanager.fmgd_router_multicastflow:
