:source: fmgd_router_ospf_network.py

:orphan:

.. _fmgd_router_ospf_network:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ospf_network</span> - OSPF network configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: OSPF network configuration.
        fortinet.fortimanager.fmgd_router_ospf_network:
