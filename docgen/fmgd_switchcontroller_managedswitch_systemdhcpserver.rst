:source: fmgd_switchcontroller_managedswitch_systemdhcpserver.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_systemdhcpserver:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure DHCP servers.
        fortinet.fmgdevice.fmgd_switchcontroller_managedswitch_systemdhcpserver:
