:source: fmgd_vpn_ipsec_phase2interface.py

:orphan:

.. _fmgd_vpn_ipsec_phase2interface:
...
.. raw:: html
 ...
 <li><span class="li-head">vpn_ipsec_phase2interface</span> - Configure VPN autokey tunnel. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">auto_discovery_forwarder</span> <b>(Alias name: auto-discovery-forwarder)</b>  Enable/disable forwarding short-cut messages. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable, phase1]</span> 
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.6 -> v7.2.8</code>, <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auto_discovery_sender</span> <b>(Alias name: auto-discovery-sender)</b>  Enable/disable sending short-cut messages. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable, phase1]</span> 
 ...
 <li><span class="li-head">dst_addr_type</span> <b>(Alias name: dst-addr-type)</b>  Remote proxy id type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [subnet, range, ip, name, subnet6, range6, ip6, name6]</span> 
 ...
 <li><span class="li-head">src_addr_type</span> <b>(Alias name: src-addr-type)</b>  Local proxy id type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [subnet, range, ip, name, subnet6, range6, ip6, name6]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure VPN autokey tunnel.
        fortinet.fortimanager.fmgd_vpn_ipsec_phase2interface:
