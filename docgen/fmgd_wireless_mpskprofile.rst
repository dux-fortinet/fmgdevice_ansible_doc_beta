:source: fmgd_wireless_mpskprofile.py

:orphan:

.. _fmgd_wireless_mpskprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_mpskprofile</span> - Configure MPSK profile. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure MPSK profile.
        fortinet.fortimanager.fmgd_wireless_mpskprofile:
