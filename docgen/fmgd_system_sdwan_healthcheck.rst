:source: fmgd_system_sdwan_healthcheck.py

:orphan:

.. _fmgd_system_sdwan_healthcheck:
...
.. raw:: html
 ...
 <li><span class="li-head">system_sdwan_healthcheck</span> - SD-WAN status checking or health checking. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: SD-WAN status checking or health checking.
        fortinet.fortimanager.fmgd_system_sdwan_healthcheck:
