:source: fmgd_webproxy_implicitproxyrule_proxyservers.py

:orphan:

.. _fmgd_webproxy_implicitproxyrule_proxyservers:
...
.. raw:: html
 ...
 <li><span class="li-head">implicit_proxy_rule</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">webproxy_implicitproxyrule_proxyservers</span> - Device vdom web proxy implicit proxy rule proxy servers <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy implicit proxy rule proxy servers
        fortinet.fmgdevice.fmgd_webproxy_implicitproxyrule_proxyservers:
          ...
          vdom: <your own value>
          implicit_proxy_rule: <your own value>
          state: present # <value in [present, absent]>
          webproxy_implicitproxyrule_proxyservers:
