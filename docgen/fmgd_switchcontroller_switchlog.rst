:source: fmgd_switchcontroller_switchlog.py

:orphan:

.. _fmgd_switchcontroller_switchlog:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_switchlog</span> - Configure FortiSwitch logging <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">status</span> Enable/disable adding fortiswitch logs to fortigate event log. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch logging
        fortinet.fortimanager.fmgd_switchcontroller_switchlog:
