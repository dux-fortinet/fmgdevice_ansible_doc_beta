:source: fmgd_extensioncontroller_extenderprofile_cellular_smsnotification_alert.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_cellular_smsnotification_alert:
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: SMS alert list.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_cellular_smsnotification_alert:
