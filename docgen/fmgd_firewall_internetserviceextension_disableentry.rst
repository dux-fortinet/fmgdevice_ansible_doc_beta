:source: fmgd_firewall_internetserviceextension_disableentry.py

:orphan:

.. _fmgd_firewall_internetserviceextension_disableentry:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Disable entries in the Internet Service database.
        fortinet.fortimanager.fmgd_firewall_internetserviceextension_disableentry:
