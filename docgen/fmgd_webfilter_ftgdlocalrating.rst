:source: fmgd_webfilter_ftgdlocalrating.py

:orphan:

.. _fmgd_webfilter_ftgdlocalrating:
...
.. raw:: html
 ...
 <li><span class="li-head">rating</span> Local rating. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure local FortiGuard Web Filter local ratings.
        fortinet.fmgdevice.fmgd_webfilter_ftgdlocalrating:
