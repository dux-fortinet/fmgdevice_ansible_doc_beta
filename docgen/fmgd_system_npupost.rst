:source: fmgd_system_npupost.py

:orphan:

.. _fmgd_system_npupost:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npupost</span> - Configure NPU attributes after interface initialization. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
