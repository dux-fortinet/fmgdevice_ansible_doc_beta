:source: fmgd_icap_remoteserver.py

:orphan:

.. _fmgd_icap_remoteserver:
...
.. raw:: html
 ...
 <li><span class="li-head">icap_remoteserver</span> - Device vdom icap remote server <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">ip_address</span> <b>(Alias name: ip-address)</b>  Ip address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">secure</span> Secure. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom icap remote server
        fortinet.fmgdevice.fmgd_icap_remoteserver:
