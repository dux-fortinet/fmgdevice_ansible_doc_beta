:source: fmgd_wireless_utmprofile.py

:orphan:

.. _fmgd_wireless_utmprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_utmprofile</span> - Configure UTM <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure UTM
        fortinet.fortimanager.fmgd_wireless_utmprofile:
