:source: fmgd_log_syslogd2_overridesetting_logtemplates.py

:orphan:

.. _fmgd_log_syslogd2_overridesetting_logtemplates:
...
.. raw:: html
 ...
 <li><span class="li-head">log_syslogd2_overridesetting_logtemplates</span> - Device vdom log syslogd2 override setting log templates <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom log syslogd2 override setting log templates
        fortinet.fmgdevice.fmgd_log_syslogd2_overridesetting_logtemplates:
          ...
          log_syslogd2_overridesetting_logtemplates:
