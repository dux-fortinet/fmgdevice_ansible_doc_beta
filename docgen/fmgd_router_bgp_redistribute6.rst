:source: fmgd_router_bgp_redistribute6.py

:orphan:

.. _fmgd_router_bgp_redistribute6:
...
.. raw:: html
 ...
 <li><span class="li-head">router_bgp_redistribute6</span> - BGP IPv6 redistribute table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: BGP IPv6 redistribute table.
        fortinet.fortimanager.fmgd_router_bgp_redistribute6:
