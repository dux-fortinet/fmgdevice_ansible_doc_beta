:source: fmgd_switchcontroller_managedswitch_igmpsnooping_vlans.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_igmpsnooping_vlans:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_managedswitch_igmpsnooping_vlans</span> - Configure IGMP snooping VLAN. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IGMP snooping VLAN.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_igmpsnooping_vlans:
