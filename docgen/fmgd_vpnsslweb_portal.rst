:source: fmgd_vpnsslweb_portal.py

:orphan:

.. _fmgd_vpnsslweb_portal:
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">allow_user_access</span> <b>(Alias name: allow-user-access)</b>  Allow user access to agentless vpn applications. <span class="li-normal">type: list</span> <span class="li-normal">choices: [web, ftp, telnet, smb, vnc, rdp, ssh, ping, sftp, citrix, portforward]</span> 
 ...
 <li><span class="li-head">custom_lang</span> <b>(Alias name: custom-lang)</b>  Change the web portal display language. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">focus_bookmark</span> <b>(Alias name: focus-bookmark)</b>  Enable to prioritize the placement of the bookmark section over the quick-connection section in the agentless vpn application. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">host_check_policy</span> <b>(Alias name: host-check-policy)</b>  One or more policies to require the endpoint to have specific security software. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ip_pools</span> <b>(Alias name: ip-pools)</b>  Ipv4 firewall source address objects reserved for ssl-vpn tunnel mode clients. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ipv6_pools</span> <b>(Alias name: ipv6-pools)</b>  Ipv6 firewall source address objects reserved for ssl-vpn tunnel mode clients. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ipv6_split_tunneling_routing_address</span> <b>(Alias name: ipv6-split-tunneling-routing-address)</b>  Ipv6 ssl-vpn tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">landing_page_mode</span> <b>(Alias name: landing-page-mode)</b>  Enable/disable agentless vpn landing page mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 <a id='label176' href="javascript:ContentClick('label177', 'label176');" onmouseover="ContentPreview('label177');" onmouseout="ContentUnpreview('label177');" title="click to collapse or expand..."> more... </a>
 <div id="label177" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">limit_user_logins</span> <b>(Alias name: limit-user-logins)</b>  Enable to limit each user to one agentless vpn session at a time. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">prefer_ipv6_dns</span> <b>(Alias name: prefer-ipv6-dns)</b>  Prefer to query ipv6 dns server first if enabled. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">rewrite_ip_uri_ui</span> <b>(Alias name: rewrite-ip-uri-ui)</b>  Rewrite contents for uri contains ip and /ui/ (default = disable). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">split_tunneling_routing_address</span> <b>(Alias name: split-tunneling-routing-address)</b>  Ipv4 ssl-vpn tunnel mode firewall address objects that override firewall policy destination addresses to control split-tunneling access. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">theme</span> Web portal color scheme. <span class="li-normal">type: str</span> <span class="li-normal">choices: [melongene, mariner, neutrino, jade, graphite, dark-matter, onyx, eclipse, jet-stream, security-fabric, green, blue]</span> 
 ...
 <li><span class="li-head">web_mode</span> <b>(Alias name: web-mode)</b>  Enable/disable agentless vpn web mode. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">dhcp_reservation</span> <b>(Alias name: dhcp-reservation)</b>  Dhcp reservation. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Portal.
        fortinet.fmgdevice.fmgd_vpnsslweb_portal:
