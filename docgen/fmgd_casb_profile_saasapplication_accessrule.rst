:source: fmgd_casb_profile_saasapplication_accessrule.py

:orphan:

.. _fmgd_casb_profile_saasapplication_accessrule:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: CASB profile access rule.
        fortinet.fmgdevice.fmgd_casb_profile_saasapplication_accessrule:
