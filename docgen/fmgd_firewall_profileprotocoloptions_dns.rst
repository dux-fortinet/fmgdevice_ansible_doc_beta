:source: fmgd_firewall_profileprotocoloptions_dns.py

:orphan:

.. _fmgd_firewall_profileprotocoloptions_dns:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure DNS protocol options.
        fortinet.fmgdevice.fmgd_firewall_profileprotocoloptions_dns:
