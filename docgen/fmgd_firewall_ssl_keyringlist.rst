:source: fmgd_firewall_ssl_keyringlist.py

:orphan:

.. _fmgd_firewall_ssl_keyringlist:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_ssl_keyringlist</span> - Device firewall ssl keyring list <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device firewall ssl keyring list
        fortinet.fmgdevice.fmgd_firewall_ssl_keyringlist:
