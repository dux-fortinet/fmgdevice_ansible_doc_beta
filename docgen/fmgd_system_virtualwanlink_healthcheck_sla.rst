:source: fmgd_system_virtualwanlink_healthcheck_sla.py

:orphan:

.. _fmgd_system_virtualwanlink_healthcheck_sla:
...
.. raw:: html
 ...
 <li><span class="li-head">system_virtualwanlink_healthcheck_sla</span> - Service level agreement <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Service level agreement
        fortinet.fortimanager.fmgd_system_virtualwanlink_healthcheck_sla:
