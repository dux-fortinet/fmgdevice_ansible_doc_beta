:source: fmgd_webproxy_redirectprofile.py

:orphan:

.. _fmgd_webproxy_redirectprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_redirectprofile</span> - Device vdom web proxy redirect profile <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy redirect profile
        fortinet.fmgdevice.fmgd_webproxy_redirectprofile:
