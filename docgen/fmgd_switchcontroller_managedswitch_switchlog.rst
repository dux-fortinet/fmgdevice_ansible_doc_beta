:source: fmgd_switchcontroller_managedswitch_switchlog.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_switchlog:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit FortiSwitch logging settings
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_switchlog:
