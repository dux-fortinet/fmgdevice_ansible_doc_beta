:source: fmgd_router_isis_isisnet.py

:orphan:

.. _fmgd_router_isis_isisnet:
...
.. raw:: html
 ...
 <li><span class="li-head">router_isis_isisnet</span> - IS-IS net configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: IS-IS net configuration.
        fortinet.fortimanager.fmgd_router_isis_isisnet:
