:source: fmgd_wireless_snmp_user.py

:orphan:

.. _fmgd_wireless_snmp_user:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_snmp_user</span> - SNMP User Configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: SNMP User Configuration.
        fortinet.fortimanager.fmgd_wireless_snmp_user:
