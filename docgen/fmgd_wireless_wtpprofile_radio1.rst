:source: fmgd_wireless_wtpprofile_radio1.py

:orphan:

.. _fmgd_wireless_wtpprofile_radio1:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_wtpprofile_radio1</span> - Configuration options for radio 1. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration options for radio 1.
        fortinet.fortimanager.fmgd_wireless_wtpprofile_radio1:
