:source: fmgd_extensioncontroller_extenderprofile_wifi_radio2.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_wifi_radio2:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Radio-2 config for Wi-Fi 5GHz
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_wifi_radio2:
