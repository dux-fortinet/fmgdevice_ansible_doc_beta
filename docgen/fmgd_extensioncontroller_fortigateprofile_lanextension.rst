:source: fmgd_extensioncontroller_fortigateprofile_lanextension.py

:orphan:

.. _fmgd_extensioncontroller_fortigateprofile_lanextension:
...
.. raw:: html
 ...
 <li><span class="li-head">fortigate-profile</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">extensioncontroller_fortigateprofile_lanextension</span> - FortiGate connector LAN extension configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiGate connector LAN extension configuration.
        fortinet.fortimanager.fmgd_extensioncontroller_fortigateprofile_lanextension:
