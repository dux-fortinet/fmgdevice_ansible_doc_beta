...
.. raw:: html
 ...
 <li><span class="li-head">session_table_percentage</span> <b>(Alias name: session-table-percentage)</b>  Percentage of main memory allocated to dpdk session table. <span class="li-normal">type: int</span>
