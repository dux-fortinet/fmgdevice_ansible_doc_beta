:source: fmgd_log_nulldevice_filter.py

:orphan:

.. _fmgd_log_nulldevice_filter:
...
.. raw:: html
 ...
 <li><span class="li-head">log_nulldevice_filter</span> - Filters for null device logging. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Filters for null device logging.
        fortinet.fortimanager.fmgd_log_nulldevice_filter:
