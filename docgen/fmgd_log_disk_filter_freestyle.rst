:source: fmgd_log_disk_filter_freestyle.py

:orphan:

.. _fmgd_log_disk_filter_freestyle:
...
.. raw:: html
 ...
 <li><span class="li-head">log_disk_filter_freestyle</span> - Free style filters. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Free style filters.
        fortinet.fortimanager.fmgd_log_disk_filter_freestyle:
