:source: fmgd_webproxy_urllist.py

:orphan:

.. _fmgd_webproxy_urllist:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_urllist</span> - Device vdom web proxy url list <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy url list
        fortinet.fmgdevice.fmgd_webproxy_urllist:
