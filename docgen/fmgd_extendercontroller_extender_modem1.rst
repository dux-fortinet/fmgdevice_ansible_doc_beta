:source: fmgd_extendercontroller_extender_modem1.py

:orphan:

.. _fmgd_extendercontroller_extender_modem1:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration options for modem 1.
        fortinet.fortimanager.fmgd_extendercontroller_extender_modem1:
