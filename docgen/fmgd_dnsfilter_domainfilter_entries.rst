:source: fmgd_dnsfilter_domainfilter_entries.py

:orphan:

.. _fmgd_dnsfilter_domainfilter_entries:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: DNS domain filter entries.
        fortinet.fmgdevice.fmgd_dnsfilter_domainfilter_entries:
