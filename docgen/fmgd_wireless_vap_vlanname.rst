:source: fmgd_wireless_vap_vlanname.py

:orphan:

.. _fmgd_wireless_vap_vlanname:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_vap_vlanname</span> - Table for mapping VLAN name to VLAN ID. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Table for mapping VLAN name to VLAN ID.
        fortinet.fortimanager.fmgd_wireless_vap_vlanname:
