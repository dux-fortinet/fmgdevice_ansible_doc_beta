:source: fmgd_switchcontroller_remotelog.py

:orphan:

.. _fmgd_switchcontroller_remotelog:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_remotelog</span> - Configure logging by FortiSwitch device to a remote syslog server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure logging by FortiSwitch device to a remote syslog server.
        fortinet.fortimanager.fmgd_switchcontroller_remotelog:
