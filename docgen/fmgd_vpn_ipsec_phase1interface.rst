  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure VPN remote gateway.
        fortinet.fortimanager.fmgd_vpn_ipsec_phase1interface:
