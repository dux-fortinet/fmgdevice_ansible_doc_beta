:source: fmgd_router_ripng_network.py

:orphan:

.. _fmgd_router_ripng_network:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ripng_network</span> - Network. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Network.
        fortinet.fortimanager.fmgd_router_ripng_network:
