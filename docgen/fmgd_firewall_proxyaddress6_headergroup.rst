:source: fmgd_firewall_proxyaddress6_headergroup.py

:orphan:

.. _fmgd_firewall_proxyaddress6_headergroup:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_proxyaddress6_headergroup</span> - Device vdom firewall proxy address6 header group <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom firewall proxy address6 header group
        fortinet.fmgdevice.fmgd_firewall_proxyaddress6_headergroup:
