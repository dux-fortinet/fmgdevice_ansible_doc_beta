:source: fmgd_vpnsslweb_usergroupbookmark_bookmarks_formdata.py

:orphan:

.. _fmgd_vpnsslweb_usergroupbookmark_bookmarks_formdata:
...
.. raw:: html
 ...
 <li><span class="li-head">vpnsslweb_usergroupbookmark_bookmarks_formdata</span> - Form data. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Form data.
        fortinet.fortimanager.fmgd_vpnsslweb_usergroupbookmark_bookmarks_formdata:
