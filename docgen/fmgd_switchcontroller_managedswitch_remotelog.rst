:source: fmgd_switchcontroller_managedswitch_remotelog.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_remotelog:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure logging by FortiSwitch device to a remote syslog server.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_remotelog:
