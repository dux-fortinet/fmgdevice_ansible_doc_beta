:source: fmgd_webproxy_dynamicbypass.py

:orphan:

.. _fmgd_webproxy_dynamicbypass:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_dynamicbypass</span> - Device vdom web proxy dynamic bypass <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">errors</span> Errors. <span class="li-normal">type: list</span> <span class="li-normal">choices: [connect-error, receive-error, non-http, 400, 401, 403, 405, 406, 500, 502, 503, 504]</span> 
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">server_max</span> <b>(Alias name: server-max)</b>  Server max. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">total_max</span> <b>(Alias name: total-max)</b>  Total max. <span class="li-normal">type: int</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom web proxy dynamic bypass
        fortinet.fmgdevice.fmgd_webproxy_dynamicbypass:
