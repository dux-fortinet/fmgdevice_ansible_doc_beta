:source: fmgd_switchcontroller_macpolicy.py

:orphan:

.. _fmgd_switchcontroller_macpolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">traffic_policy</span> <b>(Alias name: traffic-policy)</b>  Traffic policy to be applied when using this mac policy. <span class="li-normal">type: list</span>
 <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
 <div id="label11" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.6 -> v7.2.8</code>, <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">vlan</span> Ingress traffic vlan assignment for the mac address matching this mac policy. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure MAC policy to be applied on the managed FortiSwitch devices through NAC device.
        fortinet.fortimanager.fmgd_switchcontroller_macpolicy:
