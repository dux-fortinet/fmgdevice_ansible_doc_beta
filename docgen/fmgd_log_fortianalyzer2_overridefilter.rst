:source: fmgd_log_fortianalyzer2_overridefilter.py

:orphan:

.. _fmgd_log_fortianalyzer2_overridefilter:
...
.. raw:: html
 ...
 <li><span class="li-head">log_fortianalyzer2_overridefilter</span> - Override filters for FortiAnalyzer. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Override filters for FortiAnalyzer.
        fortinet.fortimanager.fmgd_log_fortianalyzer2_overridefilter:
