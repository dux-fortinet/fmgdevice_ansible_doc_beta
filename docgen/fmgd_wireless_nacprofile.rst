:source: fmgd_wireless_nacprofile.py

:orphan:

.. _fmgd_wireless_nacprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_nacprofile</span> - Configure WiFi network access control <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">onboarding_vlan</span> <b>(Alias name: onboarding-vlan)</b>  Vlan interface name. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure WiFi network access control
        fortinet.fortimanager.fmgd_wireless_nacprofile:
