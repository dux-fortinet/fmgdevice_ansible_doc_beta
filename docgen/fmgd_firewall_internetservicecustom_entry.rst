:source: fmgd_firewall_internetservicecustom_entry.py

:orphan:

.. _fmgd_firewall_internetservicecustom_entry:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Entries added to the Internet Service database and custom database.
        fortinet.fmgdevice.fmgd_firewall_internetservicecustom_entry:
