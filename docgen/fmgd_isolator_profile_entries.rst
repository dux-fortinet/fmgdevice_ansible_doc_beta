:source: fmgd_isolator_profile_entries.py

:orphan:

.. _fmgd_isolator_profile_entries:
...
.. raw:: html
 ...
 <li><span class="li-head">isolator_profile_entries</span> - Device vdom isolator profile entries <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom isolator profile entries
        fortinet.fmgdevice.fmgd_isolator_profile_entries:
