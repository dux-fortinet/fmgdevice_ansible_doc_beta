:source: fmgd_wireless_ssidpolicy.py

:orphan:

.. _fmgd_wireless_ssidpolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">vlan</span> Vlan interface name. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure WiFi SSID policies.
        fortinet.fortimanager.fmgd_wireless_ssidpolicy:
