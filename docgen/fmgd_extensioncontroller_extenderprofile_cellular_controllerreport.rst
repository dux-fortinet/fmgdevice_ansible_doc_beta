:source: fmgd_extensioncontroller_extenderprofile_cellular_controllerreport.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_cellular_controllerreport:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiExtender controller report configuration.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_cellular_controllerreport:
