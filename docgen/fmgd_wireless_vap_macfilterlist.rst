:source: fmgd_wireless_vap_macfilterlist.py

:orphan:

.. _fmgd_wireless_vap_macfilterlist:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_vap_macfilterlist</span> - Create a list of MAC addresses for MAC address filtering. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Create a list of MAC addresses for MAC address filtering.
        fortinet.fortimanager.fmgd_wireless_vap_macfilterlist:
