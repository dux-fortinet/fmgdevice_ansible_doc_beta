...
.. raw:: html
 ...
 <li><span class="li-head">replacemsg_group</span> <b>(Alias name: replacemsg-group)</b>  Replacement message group used by this dlp profile. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">file_size</span> <b>(Alias name: file-size)</b>  Match files greater than or equal to this size (kb). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">label</span> Mip label dictionary. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">extended_log</span> <b>(Alias name: extended-log)</b>  Enable/disable extended logging for data loss prevention. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure DLP profiles.
        fortinet.fmgdevice.fmgd_dlp_profile:
