:source: fmgd_extendercontroller_extender_controllerreport.py

:orphan:

.. _fmgd_extendercontroller_extender_controllerreport:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiExtender controller report configuration.
        fortinet.fortimanager.fmgd_extendercontroller_extender_controllerreport:
