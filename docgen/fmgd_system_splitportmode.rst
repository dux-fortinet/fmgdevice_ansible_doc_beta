:source: fmgd_system_splitportmode.py

:orphan:

.. _fmgd_system_splitportmode:
...
.. raw:: html
 ...
 <li><span class="li-head">system_splitportmode</span> - Configure split port mode of ports. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
