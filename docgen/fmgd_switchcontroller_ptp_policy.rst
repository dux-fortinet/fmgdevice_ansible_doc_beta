:source: fmgd_switchcontroller_ptp_policy.py

:orphan:

.. _fmgd_switchcontroller_ptp_policy:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_ptp_policy</span> - PTP policy configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: PTP policy configuration.
        fortinet.fortimanager.fmgd_switchcontroller_ptp_policy:
