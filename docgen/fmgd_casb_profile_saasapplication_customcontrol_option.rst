:source: fmgd_casb_profile_saasapplication_customcontrol_option.py

:orphan:

.. _fmgd_casb_profile_saasapplication_customcontrol_option:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: CASB custom control option.
        fortinet.fmgdevice.fmgd_casb_profile_saasapplication_customcontrol_option:
