:source: fmgd_waf_profile_constraint_maxrangesegment.py

:orphan:

.. _fmgd_waf_profile_constraint_maxrangesegment:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Maximum number of range segments in HTTP range line.
        fortinet.fmgdevice.fmgd_waf_profile_constraint_maxrangesegment:
