...
.. raw:: html
 ...
 <li><span class="li-head">admin_scp</span> <b>(Alias name: admin-scp)</b>  Enable/disable scp support for system configuration backup, restore, and firmware file upload. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">admintimeout</span> Number of minutes before an idle administrator session times out (1 - 480 minutes (8 hours), default = 5). <span class="li-normal">type: int</span>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.7 -> v7.4.7</code>, <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 ...
 <li><span class="li-head">admin_timeout</span> <b>(Alias name: admin-timeout)</b>  Admin timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">http_view</span> <b>(Alias name: http-view)</b>  Http view. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">time_wait_timeout</span> <b>(Alias name: time-wait-timeout)</b>  Time wait timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">udp_stream_timeout</span> <b>(Alias name: udp-stream-timeout)</b>  Udp stream timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">established_timeout</span> <b>(Alias name: established-timeout)</b>  Established timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">syn_sent_timeout</span> <b>(Alias name: syn-sent-timeout)</b>  Syn sent timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">syn_recv_timeout</span> <b>(Alias name: syn-recv-timeout)</b>  Syn recv timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">license_overlimit</span> <b>(Alias name: license-overlimit)</b>  License overlimit. <span class="li-normal">type: str</span> <span class="li-normal">choices: [block, bypass]</span> 
 ...
 <li><span class="li-head">conntrack</span> Conntrack. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">close_wait_timeout</span> <b>(Alias name: close-wait-timeout)</b>  Close wait timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">crwl_log</span> <b>(Alias name: crwl-log)</b>  Crwl log. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">udp_timeout</span> <b>(Alias name: udp-timeout)</b>  Udp timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">fin_wait_timeout</span> <b>(Alias name: fin-wait-timeout)</b>  Fin wait timeout. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">last_ack_timeout</span> <b>(Alias name: last-ack-timeout)</b>  Last ack timeout. <span class="li-normal">type: int</span>
