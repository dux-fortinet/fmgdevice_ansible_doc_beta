:source: fmgd_user_saml_dynamicmapping.py

:orphan:

.. _fmgd_user_saml_dynamicmapping:

fmgd_user_saml_dynamicmapping -- SAML server entry configuration.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">scim_user_attr_type</span> <b>(Alias name: scim-user-attr-type)</b>  User attribute type used to match scim users (default = user-name). <span class="li-normal">type: str</span> <span class="li-normal">choices: [display-name, external-id, user-name]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: SAML server entry configuration.
        fortinet.fmgdevice.fmgd_user_saml_dynamicmapping:
