:source: fmgd_wireless_vap_vlanpool.py

:orphan:

.. _fmgd_wireless_vap_vlanpool:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_vap_vlanpool</span> - VLAN pool. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: VLAN pool.
        fortinet.fortimanager.fmgd_wireless_vap_vlanpool:
