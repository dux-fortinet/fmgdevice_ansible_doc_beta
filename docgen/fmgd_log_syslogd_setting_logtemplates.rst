:source: fmgd_log_syslogd_setting_logtemplates.py

:orphan:

.. _fmgd_log_syslogd_setting_logtemplates:
...
.. raw:: html
 ...
 <li><span class="li-head">log_syslogd_setting_logtemplates</span> - Device log syslogd setting log templates <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device log syslogd setting log templates
        fortinet.fmgdevice.fmgd_log_syslogd_setting_logtemplates:
          ...
          log_syslogd_setting_logtemplates:
