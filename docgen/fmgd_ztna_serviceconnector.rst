:source: fmgd_ztna_serviceconnector.py

:orphan:

.. _fmgd_ztna_serviceconnector:
...
.. raw:: html
 ...
 <li><span class="li-head">ztna_serviceconnector</span> - Device vdom ztna service connector <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom ztna service connector
        fortinet.fmgdevice.fmgd_ztna_serviceconnector:
