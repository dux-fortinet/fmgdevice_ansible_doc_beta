:source: fmgd_router_ospf_summaryaddress.py

:orphan:

.. _fmgd_router_ospf_summaryaddress:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ospf_summaryaddress</span> - IP address summary configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: IP address summary configuration.
        fortinet.fortimanager.fmgd_router_ospf_summaryaddress:
