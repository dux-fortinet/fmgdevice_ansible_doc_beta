:source: fmgd_firewall_proxyaddrgrp6.py

:orphan:

.. _fmgd_firewall_proxyaddrgrp6:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_proxyaddrgrp6</span> - Device vdom firewall proxy addrgrp6 <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom firewall proxy addrgrp6
        fortinet.fmgdevice.fmgd_firewall_proxyaddrgrp6:
