:source: fmgd_user_group_dynamicmapping.py

:orphan:

.. _fmgd_user_group_dynamicmapping:

fmgd_user_group_dynamicmapping -- Configure user groups.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">group_type</span> <b>(Alias name: group-type)</b>  Set the group to be for firewall authentication, fsso, rsso, or guest users. <span class="li-normal">type: str</span> <span class="li-normal">choices: [firewall, fsso-service, guest, rsso]</span> 
 ...
 <li><span class="li-head">group_name</span> <b>(Alias name: group-name)</b>  Name of matching user or group on remote authentication server or scim. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server_name</span> <b>(Alias name: server-name)</b>  Name of remote auth server. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">member</span> Names of users, peers, ldap severs, radius servers or external idp servers to add to the user group. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">sms_custom_server</span> <b>(Alias name: sms-custom-server)</b>  Sms server. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">sslvpn_bookmarks_group</span> <b>(Alias name: sslvpn-bookmarks-group)</b>  Sslvpn bookmarks group. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">sslvpn_portal</span> <b>(Alias name: sslvpn-portal)</b>  Sslvpn portal. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">sso_attribute_value</span> <b>(Alias name: sso-attribute-value)</b>  Radius attribute value. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure user groups.
        fortinet.fmgdevice.fmgd_user_group_dynamicmapping:
          ...
          user_group_dynamicmapping:
            ...
            # group_type: <value in [firewall, fsso-service, guest, ...]>
            # guest:
            #   - comment: <string>
            #     company: <string>
            #     email: <string>
