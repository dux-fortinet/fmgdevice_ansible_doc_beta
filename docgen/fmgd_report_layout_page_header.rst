:source: fmgd_report_layout_page_header.py

:orphan:

.. _fmgd_report_layout_page_header:
...
.. raw:: html
 ...
 <li><span class="li-head">report_layout_page_header</span> - Configure report page header. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure report page header.
        fortinet.fortimanager.fmgd_report_layout_page_header:
