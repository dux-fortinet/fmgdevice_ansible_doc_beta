:source: fmgd_switchcontroller_qos_queuepolicy_cosqueue.py

:orphan:

.. _fmgd_switchcontroller_qos_queuepolicy_cosqueue:
...
.. raw:: html
 ...
 <li><span class="li-head">queue-policy</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 ...
 <li><span class="li-head">max_rate_percent</span> <b>(Alias name: max-rate-percent)</b>  Maximum rate (% of link speed). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">min_rate_percent</span> <b>(Alias name: min-rate-percent)</b>  Minimum rate (% of link speed). <span class="li-normal">type: int</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: COS queue configuration.
        fortinet.fortimanager.fmgd_switchcontroller_qos_queuepolicy_cosqueue:
