:source: fmgd_system_virtualwanlink_service.py

:orphan:

.. _fmgd_system_virtualwanlink_service:
...
.. raw:: html
 ...
 <li><span class="li-head">system_virtualwanlink_service</span> - Create SD-WAN rules <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Create SD-WAN rules
        fortinet.fortimanager.fmgd_system_virtualwanlink_service:
