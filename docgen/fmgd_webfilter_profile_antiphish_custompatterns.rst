:source: fmgd_webfilter_profile_antiphish_custompatterns.py

:orphan:

.. _fmgd_webfilter_profile_antiphish_custompatterns:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Custom username and password regex patterns.
        fortinet.fmgdevice.fmgd_webfilter_profile_antiphish_custompatterns:
