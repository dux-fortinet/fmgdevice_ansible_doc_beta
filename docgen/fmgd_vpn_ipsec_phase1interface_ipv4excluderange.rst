:source: fmgd_vpn_ipsec_phase1interface_ipv4excluderange.py

:orphan:

.. _fmgd_vpn_ipsec_phase1interface_ipv4excluderange:
...
.. raw:: html
 ...
 <li><span class="li-head">phase1-interface</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">vpn_ipsec_phase1interface_ipv4excluderange</span> - Configuration Method IPv4 exclude ranges. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration Method IPv4 exclude ranges.
        fortinet.fortimanager.fmgd_vpn_ipsec_phase1interface_ipv4excluderange:
