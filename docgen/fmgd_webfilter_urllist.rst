:source: fmgd_webfilter_urllist.py

:orphan:

.. _fmgd_webfilter_urllist:
...
.. raw:: html
 ...
 <li><span class="li-head">webfilter_urllist</span> - Device vdom webfilter url list <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom webfilter url list
        fortinet.fmgdevice.fmgd_webfilter_urllist:
