:source: fmgd_firewall_proxyaddress6.py

:orphan:

.. _fmgd_firewall_proxyaddress6:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_proxyaddress6</span> - Device vdom firewall proxy address6 <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">type</span> Type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [host-regex, url, category, method, ua, header, src-advanced, dst-advanced, url-list, saas, response-header]</span> 
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom firewall proxy address6
        fortinet.fmgdevice.fmgd_firewall_proxyaddress6:
