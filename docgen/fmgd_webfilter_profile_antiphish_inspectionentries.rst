:source: fmgd_webfilter_profile_antiphish_inspectionentries.py

:orphan:

.. _fmgd_webfilter_profile_antiphish_inspectionentries:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: AntiPhishing entries.
        fortinet.fmgdevice.fmgd_webfilter_profile_antiphish_inspectionentries:
