:source: fmgd_firewall_profileprotocoloptions_cifs_serverkeytab.py

:orphan:

.. _fmgd_firewall_profileprotocoloptions_cifs_serverkeytab:
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Server keytab.
        fortinet.fmgdevice.fmgd_firewall_profileprotocoloptions_cifs_serverkeytab:
