:source: fmgd_switchcontroller_managedswitch_ports.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_ports:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Managed-switch port list.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_ports:
