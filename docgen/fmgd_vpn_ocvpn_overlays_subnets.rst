:source: fmgd_vpn_ocvpn_overlays_subnets.py

:orphan:

.. _fmgd_vpn_ocvpn_overlays_subnets:
...
.. raw:: html
 ...
 <li><span class="li-head">overlays</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">vpn_ocvpn_overlays_subnets</span> - Internal subnets to register with OCVPN service. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Internal subnets to register with OCVPN service.
        fortinet.fortimanager.fmgd_vpn_ocvpn_overlays_subnets:
