:source: fmgd_system_replacemsggroup_custommessage.py

:orphan:

.. _fmgd_system_replacemsggroup_custommessage:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Replacement message table entries.
        fortinet.fmgdevice.fmgd_system_replacemsggroup_custommessage:
