:source: fmgd_router_ospf_distributelist.py

:orphan:

.. _fmgd_router_ospf_distributelist:
...
.. raw:: html
 ...
 <li><span class="li-head">router_ospf_distributelist</span> - Distribute list configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Distribute list configuration.
        fortinet.fortimanager.fmgd_router_ospf_distributelist:
