...
.. raw:: html
 ...
 <li><span class="li-head">user-bookmark</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">vpnsslweb_userbookmark_bookmarks</span> - Bookmark table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Bookmark table.
        fortinet.fortimanager.fmgd_vpnsslweb_userbookmark_bookmarks:
