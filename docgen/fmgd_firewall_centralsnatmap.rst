:source: fmgd_firewall_centralsnatmap.py

:orphan:

.. _fmgd_firewall_centralsnatmap:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_centralsnatmap</span> - Configure IPv4 and IPv6 central SNAT policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">action</span> Action. <span class="li-normal">type: str</span> <span class="li-normal">choices: [bypass, masquerade, ippool]</span> 
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">dst_addr</span> <b>(Alias name: dst-addr)</b>  Ipv4 destination address. <span class="li-normal">type: list</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">dst_addr6</span> <b>(Alias name: dst-addr6)</b>  Ipv6 destination address. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ipv6</span> Ipv6. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">nat_ippool</span> <b>(Alias name: nat-ippool)</b>  Name of the ip pools to be used to translate addresses from available ip pools. <span class="li-normal">type: list</span>
 <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
 <div id="label11" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">nat_ippool6</span> <b>(Alias name: nat-ippool6)</b>  Ipv6 pools to be used for source nat. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">src_addr</span> <b>(Alias name: src-addr)</b>  Src addr. <span class="li-normal">type: list</span>
 <a id='label16' href="javascript:ContentClick('label17', 'label16');" onmouseover="ContentPreview('label17');" onmouseout="ContentUnpreview('label17');" title="click to collapse or expand..."> more... </a>
 <div id="label17" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">src_addr6</span> <b>(Alias name: src-addr6)</b>  Src addr6. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">nat_port</span> <b>(Alias name: nat-port)</b>  Translated port or port range (1 to 65535, 0 means any port). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">orig_addr6</span> <b>(Alias name: orig-addr6)</b>  Ipv6 original address. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">orig_port</span> <b>(Alias name: orig-port)</b>  Original tcp port (1 to 65535, 0 means any port). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">orig_addr</span> <b>(Alias name: orig-addr)</b>  Ipv4 original address. <span class="li-normal">type: list</span>
