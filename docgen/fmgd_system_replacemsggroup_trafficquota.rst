:source: fmgd_system_replacemsggroup_trafficquota.py

:orphan:

.. _fmgd_system_replacemsggroup_trafficquota:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Replacement message table entries.
        fortinet.fmgdevice.fmgd_system_replacemsggroup_trafficquota:
