:source: fmgd_router_multicast6_pimsmglobal_rpaddress.py

:orphan:

.. _fmgd_router_multicast6_pimsmglobal_rpaddress:
...
.. raw:: html
 ...
 <li><span class="li-head">router_multicast6_pimsmglobal_rpaddress</span> - Statically configured RP addresses. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Statically configured RP addresses.
        fortinet.fortimanager.fmgd_router_multicast6_pimsmglobal_rpaddress:
