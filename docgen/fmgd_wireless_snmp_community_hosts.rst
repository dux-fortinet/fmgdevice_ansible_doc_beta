:source: fmgd_wireless_snmp_community_hosts.py

:orphan:

.. _fmgd_wireless_snmp_community_hosts:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_snmp_community_hosts</span> - Configure IPv4 SNMP managers <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv4 SNMP managers
        fortinet.fortimanager.fmgd_wireless_snmp_community_hosts:
