:source: fmgd_webproxy_forwardservergroup_serverlist.py

:orphan:

.. _fmgd_webproxy_forwardservergroup_serverlist:
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">name</span> Forward server name. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Add web forward servers to a list to form a server group.
        fortinet.fmgdevice.fmgd_webproxy_forwardservergroup_serverlist:
