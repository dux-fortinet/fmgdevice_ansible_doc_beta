:source: fmgd_wireless_wtpprofile_radio2.py

:orphan:

.. _fmgd_wireless_wtpprofile_radio2:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_wtpprofile_radio2</span> - Configuration options for radio 2. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration options for radio 2.
        fortinet.fortimanager.fmgd_wireless_wtpprofile_radio2:
