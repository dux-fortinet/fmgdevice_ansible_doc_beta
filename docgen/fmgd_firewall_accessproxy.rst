:source: fmgd_firewall_accessproxy.py

:orphan:

.. _fmgd_firewall_accessproxy:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_accessproxy</span> - Configure IPv4 access proxy. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">ldb_method</span> <b>(Alias name: ldb-method)</b>  Method used to distribute sessions to real servers. <span class="li-normal">type: str</span> <span class="li-normal">choices: [static, round-robin, weighted, first-alive, http-host, least-session, least-rtt]</span> 
 ...
 <li><span class="li-head">mappedport</span> Port for communicating with the real server. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ssh_client_cert</span> <b>(Alias name: ssh-client-cert)</b>  Set access-proxy ssh client certificate profile. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">saml_server</span> <b>(Alias name: saml-server)</b>  Saml service provider configuration for vip authentication. <span class="li-normal">type: list</span>
 <a id='label94' href="javascript:ContentClick('label95', 'label94');" onmouseover="ContentPreview('label95');" onmouseout="ContentUnpreview('label95');" title="click to collapse or expand..."> more... </a>
 <div id="label95" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">service</span> Service. <span class="li-normal">type: str</span> <span class="li-normal">choices: [http, https, tcp-forwarding, samlsp, saas, web-portal]</span> 
 ...
 <li><span class="li-head">virtual_host</span> <b>(Alias name: virtual-host)</b>  Virtual host. <span class="li-normal">type: list</span>
 <a id='label120' href="javascript:ContentClick('label121', 'label120');" onmouseover="ContentPreview('label121');" onmouseout="ContentUnpreview('label121');" title="click to collapse or expand..."> more... </a>
 <div id="label121" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">ssl_vpn_web_portal</span> <b>(Alias name: ssl-vpn-web-portal)</b>  Agentless vpn web portal. <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">auth_ca</span> <b>(Alias name: auth-ca)</b>  Auth ca. <span class="li-normal">type: list</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">critical</span> Critical. <span class="li-normal">type: str</span> <span class="li-normal">choices: [no, yes]</span> 
 ...
 <li><span class="li-head">data</span> Data. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">type</span> Type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [fixed, user]</span> 
 ...
 <li><span class="li-head">permit_agent_forwarding</span> <b>(Alias name: permit-agent-forwarding)</b>  Permit agent forwarding. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">permit_port_forwarding</span> <b>(Alias name: permit-port-forwarding)</b>  Permit port forwarding. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">permit_pty</span> <b>(Alias name: permit-pty)</b>  Permit pty. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">permit_user_rc</span> <b>(Alias name: permit-user-rc)</b>  Permit user rc. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">permit_x11_forwarding</span> <b>(Alias name: permit-x11-forwarding)</b>  Permit x11 forwarding. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">source_address</span> <b>(Alias name: source-address)</b>  Source address. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">server_pubkey_auth</span> <b>(Alias name: server-pubkey-auth)</b>  Server pubkey auth. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv4 access proxy.
        fortinet.fmgdevice.fmgd_firewall_accessproxy:
          ...
          firewall_accessproxy:
            ...
            #     virtual_host: <list or string>
            #     ssl_vpn_web_portal: <list or string>
            # api_gateway6:
            #   - application: <list or string>
            #     h2_support: <value in [disable, enable]>
            #     h3_support: <value in [disable, enable]>
