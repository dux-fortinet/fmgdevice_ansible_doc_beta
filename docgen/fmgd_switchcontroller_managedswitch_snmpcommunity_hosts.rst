:source: fmgd_switchcontroller_managedswitch_snmpcommunity_hosts.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_snmpcommunity_hosts:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv4 SNMP managers
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_snmpcommunity_hosts:
