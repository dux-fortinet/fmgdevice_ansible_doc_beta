:source: fmgd_wireless_vap_dynamicmapping.py

:orphan:

.. _fmgd_wireless_vap_dynamicmapping:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_vap_dynamicmapping</span> - Configure Virtual Access Points <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure Virtual Access Points
        fortinet.fortimanager.fmgd_wireless_vap_dynamicmapping:
