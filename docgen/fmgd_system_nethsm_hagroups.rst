:source: fmgd_system_nethsm_hagroups.py

:orphan:

.. _fmgd_system_nethsm_hagroups:
...
.. raw:: html
 ...
 <li><span class="li-head">system_nethsm_hagroups</span> - Device system nethsm hagroups <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device system nethsm hagroups
        fortinet.fmgdevice.fmgd_system_nethsm_hagroups:
