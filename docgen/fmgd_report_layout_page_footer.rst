:source: fmgd_report_layout_page_footer.py

:orphan:

.. _fmgd_report_layout_page_footer:
...
.. raw:: html
 ...
 <li><span class="li-head">report_layout_page_footer</span> - Configure report page footer. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure report page footer.
        fortinet.fortimanager.fmgd_report_layout_page_footer:
