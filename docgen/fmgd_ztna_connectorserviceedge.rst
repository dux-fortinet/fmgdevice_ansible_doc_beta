:source: fmgd_ztna_connectorserviceedge.py

:orphan:

.. _fmgd_ztna_connectorserviceedge:
...
.. raw:: html
 ...
 <li><span class="li-head">ztna_connectorserviceedge</span> - Device vdom ztna connector service edge <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">server_cert</span> <b>(Alias name: server-cert)</b>  Server cert. <span class="li-normal">type: list</span>
 <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 <div id="label5" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.4 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">ssl_max_version</span> <b>(Alias name: ssl-max-version)</b>  Ssl max version. <span class="li-normal">type: str</span> <span class="li-normal">choices: [tls-1.1, tls-1.2, tls-1.3]</span> 
 ...
 <li><span class="li-head">trusted_client_ca</span> <b>(Alias name: trusted-client-ca)</b>  Trusted client ca. <span class="li-normal">type: list</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom ztna connector service edge
        fortinet.fmgdevice.fmgd_ztna_connectorserviceedge:
