:source: fmgd_switchcontroller_securitypolicy_8021x.py

:orphan:

.. _fmgd_switchcontroller_securitypolicy_8021x:
...
.. raw:: html
 ...
 <li><span class="li-head">auth_fail_vlan_id</span> <b>(Alias name: auth-fail-vlan-id)</b>  Vlan id on which authentication failed. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">authserver_timeout_vlanid</span> <b>(Alias name: authserver-timeout-vlanid)</b>  Authentication server timeout vlan name. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">guest_vlan_id</span> <b>(Alias name: guest-vlan-id)</b>  Guest vlan name. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">user_group</span> <b>(Alias name: user-group)</b>  Name of user-group to assign to this mac authentication bypass (mab) policy. <span class="li-normal">type: list</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure 802.
        fortinet.fortimanager.fmgd_switchcontroller_securitypolicy_8021x:
