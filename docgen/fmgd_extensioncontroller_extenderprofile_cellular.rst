:source: fmgd_extensioncontroller_extenderprofile_cellular.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_cellular:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiExtender cellular configuration.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_cellular:
