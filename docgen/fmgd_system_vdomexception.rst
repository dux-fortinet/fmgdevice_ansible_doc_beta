:source: fmgd_system_vdomexception.py

:orphan:

.. _fmgd_system_vdomexception:
...
.. raw:: html
 ...
 <li><span class="li-head">system_vdomexception</span> - Global configuration objects that can be configured independently across different ha peers for all VDOMs or for the defined VDOM scope. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
