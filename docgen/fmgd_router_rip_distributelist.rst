:source: fmgd_router_rip_distributelist.py

:orphan:

.. _fmgd_router_rip_distributelist:
...
.. raw:: html
 ...
 <li><span class="li-head">router_rip_distributelist</span> - Distribute list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Distribute list.
        fortinet.fortimanager.fmgd_router_rip_distributelist:
