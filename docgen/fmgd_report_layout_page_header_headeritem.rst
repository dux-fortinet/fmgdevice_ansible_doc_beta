:source: fmgd_report_layout_page_header_headeritem.py

:orphan:

.. _fmgd_report_layout_page_header_headeritem:
...
.. raw:: html
 ...
 <li><span class="li-head">report_layout_page_header_headeritem</span> - Configure report header item. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure report header item.
        fortinet.fortimanager.fmgd_report_layout_page_header_headeritem:
