:source: fmgd_router_setting.py

:orphan:

.. _fmgd_router_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">show_filter</span> <b>(Alias name: show-filter)</b>  Prefix-list as filter for showing routes. <span class="li-normal">type: list</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.6 -> v7.2.8</code>, <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">kernel_route_distance</span> <b>(Alias name: kernel-route-distance)</b>  Administrative distance for routes learned from kernel (0 - 255). <span class="li-normal">type: int</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure router settings.
        fortinet.fortimanager.fmgd_router_setting:
