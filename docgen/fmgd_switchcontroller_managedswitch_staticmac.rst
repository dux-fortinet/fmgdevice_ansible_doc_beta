:source: fmgd_switchcontroller_managedswitch_staticmac.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_staticmac:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit FortiSwitch Static and Sticky MAC.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_staticmac:
