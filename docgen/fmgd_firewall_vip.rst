...
.. raw:: html
 ...
 <li><span class="li-head">type</span> Configure a static nat, load balance, server load balance, access proxy, dns translation, or fqdn vip. <span class="li-normal">type: str</span> <span class="li-normal">choices: [static-nat, server-load-balance, access-proxy, fqdn, load-balance, dns-translation]</span> 
