:source: fmgd_wireless_vap_mpskkey.py

:orphan:

.. _fmgd_wireless_vap_mpskkey:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_vap_mpskkey</span> - Device vdom wireless controller vap mpsk key <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom wireless controller vap mpsk key
        fortinet.fortimanager.fmgd_wireless_vap_mpskkey:
