:source: fmgd_firewall_accessproxy_apigateway.py

:orphan:

.. _fmgd_firewall_accessproxy_apigateway:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_accessproxy_apigateway</span> - Set IPv4 API Gateway. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Set IPv4 API Gateway.
        fortinet.fmgdevice.fmgd_firewall_accessproxy_apigateway:
