:source: fmgd_vpnsslweb_portal_bookmarkgroup_bookmarks_formdata.py

:orphan:

.. _fmgd_vpnsslweb_portal_bookmarkgroup_bookmarks_formdata:
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Form data.
        fortinet.fmgdevice.fmgd_vpnsslweb_portal_bookmarkgroup_bookmarks_formdata:
