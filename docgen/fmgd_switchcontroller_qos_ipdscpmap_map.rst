:source: fmgd_switchcontroller_qos_ipdscpmap_map.py

:orphan:

.. _fmgd_switchcontroller_qos_ipdscpmap_map:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Maps between IP-DSCP value to COS queue.
        fortinet.fortimanager.fmgd_switchcontroller_qos_ipdscpmap_map:
