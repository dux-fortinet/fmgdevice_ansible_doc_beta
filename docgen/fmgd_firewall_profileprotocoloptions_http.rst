:source: fmgd_firewall_profileprotocoloptions_http.py

:orphan:

.. _fmgd_firewall_profileprotocoloptions_http:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure HTTP protocol options.
        fortinet.fmgdevice.fmgd_firewall_profileprotocoloptions_http:
