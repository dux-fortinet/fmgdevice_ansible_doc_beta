:source: fmgd_log_nulldevice_setting.py

:orphan:

.. _fmgd_log_nulldevice_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">log_nulldevice_setting</span> - Settings for null device logging. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">status</span> Enable/disable statistics collection for when no external logging destination, such as fortianalyzer, is present (data is not saved). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Settings for null device logging.
        fortinet.fortimanager.fmgd_log_nulldevice_setting:
