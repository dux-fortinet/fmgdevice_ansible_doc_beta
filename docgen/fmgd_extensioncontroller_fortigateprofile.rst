:source: fmgd_extensioncontroller_fortigateprofile.py

:orphan:

.. _fmgd_extensioncontroller_fortigateprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">extensioncontroller_fortigateprofile</span> - FortiGate connector profile configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">extension</span> Extension. <span class="li-normal">type: str</span> <span class="li-normal">choices: [lan-extension]</span> 
 ...
 <li><span class="li-head">name</span> Fortigate connector profile name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: FortiGate connector profile configuration.
        fortinet.fortimanager.fmgd_extensioncontroller_fortigateprofile:
