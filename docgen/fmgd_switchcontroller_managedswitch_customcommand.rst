:source: fmgd_switchcontroller_managedswitch_customcommand.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_customcommand:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit FortiSwitch commands to be pushed to this FortiSwitch device upon rebooting the FortiGate switch contro...
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_customcommand:
