:source: fmgd_wireless_hotspot20_anqpnairealm_nailist.py

:orphan:

.. _fmgd_wireless_hotspot20_anqpnairealm_nailist:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_hotspot20_anqpnairealm_nailist</span> - NAI list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: NAI list.
        fortinet.fortimanager.fmgd_wireless_hotspot20_anqpnairealm_nailist:
