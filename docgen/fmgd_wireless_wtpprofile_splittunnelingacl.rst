:source: fmgd_wireless_wtpprofile_splittunnelingacl.py

:orphan:

.. _fmgd_wireless_wtpprofile_splittunnelingacl:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_wtpprofile_splittunnelingacl</span> - Split tunneling ACL filter list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Split tunneling ACL filter list.
        fortinet.fortimanager.fmgd_wireless_wtpprofile_splittunnelingacl:
