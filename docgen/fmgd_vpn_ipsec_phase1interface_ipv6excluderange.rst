:source: fmgd_vpn_ipsec_phase1interface_ipv6excluderange.py

:orphan:

.. _fmgd_vpn_ipsec_phase1interface_ipv6excluderange:
...
.. raw:: html
 ...
 <li><span class="li-head">vpn_ipsec_phase1interface_ipv6excluderange</span> - Configuration method IPv6 exclude ranges. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method IPv6 exclude ranges.
        fortinet.fortimanager.fmgd_vpn_ipsec_phase1interface_ipv6excluderange:
