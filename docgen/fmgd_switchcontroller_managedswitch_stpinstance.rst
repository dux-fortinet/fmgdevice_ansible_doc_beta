:source: fmgd_switchcontroller_managedswitch_stpinstance.py

:orphan:

.. _fmgd_switchcontroller_managedswitch_stpinstance:
...
.. raw:: html
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.0 -> v6.2.0</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.8</code>, <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configuration method to edit Spanning Tree Protocol
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch_stpinstance:
