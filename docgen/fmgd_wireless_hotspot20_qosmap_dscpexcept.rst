:source: fmgd_wireless_hotspot20_qosmap_dscpexcept.py

:orphan:

.. _fmgd_wireless_hotspot20_qosmap_dscpexcept:
...
.. raw:: html
 ...
 <li><span class="li-head">wireless_hotspot20_qosmap_dscpexcept</span> - Differentiated Services Code Point <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Differentiated Services Code Point
        fortinet.fortimanager.fmgd_wireless_hotspot20_qosmap_dscpexcept:
