:source: fmgd_firewall_service_category.py

:orphan:

.. _fmgd_firewall_service_category:
...
.. raw:: html
 ...
 <li><span class="li-head">name</span> Service category name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure service categories.
        fortinet.fmgdevice.fmgd_firewall_service_category:
