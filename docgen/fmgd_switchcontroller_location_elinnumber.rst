:source: fmgd_switchcontroller_location_elinnumber.py

:orphan:

.. _fmgd_switchcontroller_location_elinnumber:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_location_elinnumber</span> - Configure location ELIN number. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure location ELIN number.
        fortinet.fortimanager.fmgd_switchcontroller_location_elinnumber:
