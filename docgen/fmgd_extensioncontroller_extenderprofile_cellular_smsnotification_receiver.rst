:source: fmgd_extensioncontroller_extenderprofile_cellular_smsnotification_receiver.py

:orphan:

.. _fmgd_extensioncontroller_extenderprofile_cellular_smsnotification_receiver:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: SMS notification receiver list.
        fortinet.fmgdevice.fmgd_extensioncontroller_extenderprofile_cellular_smsnotification_receiver:
