:source: fmgd_user_setting_authports.py

:orphan:

.. _fmgd_user_setting_authports:
...
.. raw:: html
 ...
 <li><span class="li-head">user_setting_authports</span> - Set up non-standard ports for authentication with HTTP, HTTPS, FTP, and TELNET. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Set up non-standard ports for authentication with HTTP, HTTPS, FTP, and TELNET.
        fortinet.fortimanager.fmgd_user_setting_authports:
