:source: fmgd_certificate_hsmlocal.py

:orphan:

.. _fmgd_certificate_hsmlocal:
...
.. raw:: html
 ...
 <li><span class="li-head">certificate_hsmlocal</span> - Local certificates whose keys are stored on HSM. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Local certificates whose keys are stored on HSM.
        fortinet.fmgdevice.fmgd_certificate_hsmlocal:
