:source: fmgd_firewall_profileprotocoloptions_mailsignature.py

:orphan:

.. _fmgd_firewall_profileprotocoloptions_mailsignature:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure Mail signature.
        fortinet.fmgdevice.fmgd_firewall_profileprotocoloptions_mailsignature:
