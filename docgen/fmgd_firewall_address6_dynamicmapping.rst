:source: fmgd_firewall_address6_dynamicmapping.py

:orphan:

.. _fmgd_firewall_address6_dynamicmapping:

fmgd_firewall_address6_dynamicmapping -- Configure IPv6 firewall addresses.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">country</span> Ipv6 addresses associated to a specific country. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ip6</span> Support meta variable <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">template</span> Ipv6 address template. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">type</span> Type of ipv6 address object (default = ipprefix). <span class="li-normal">type: str</span> <span class="li-normal">choices: [ipprefix, iprange, dynamic, fqdn, template, geography, route-tag, wildcard, mac]</span> 
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure IPv6 firewall addresses.
        fortinet.fmgdevice.fmgd_firewall_address6_dynamicmapping:
          ...
          firewall_address6_dynamicmapping:
            ...
            # host: <string>
            # host_type: <value in [any, specific]>
            # ip6: <string>
            # macaddr: <list or string>
            # obj_id: <string>
            # route_tag: <integer>
            # sdn: <list or string>
            # sdn_addr_type: <value in [all, private, public]>
            # sdn_tag: <string>
            # start_ip: <string>
            # start_mac: <string>
            # subnet_segment:
