:source: fmgd_user_ldap_dynamicmapping.py

:orphan:

.. _fmgd_user_ldap_dynamicmapping:

fmgd_user_ldap_dynamicmapping -- Configure LDAP server entries.
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">search_type</span> <b>(Alias name: search-type)</b>  Search type. <span class="li-normal">type: list</span> <span class="li-normal">choices: [recursive]</span> 
 ...
 <li><span class="li-head">source_ip</span> <b>(Alias name: source-ip)</b>  Fortigate ip address to be used for communication with the ldap server. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">user_info_exchange_server</span> <b>(Alias name: user-info-exchange-server)</b>  Ms exchange server from which to fetch user information. <span class="li-normal">type: list</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure LDAP server entries.
        fortinet.fmgdevice.fmgd_user_ldap_dynamicmapping:
          ...
          user_ldap_dynamicmapping:
            ...
            # account_key_upn_san: <value in [othername, rfc822name, dnsname]>
            # antiphish: <value in [disable, enable]>
            # ca_cert: <string>
            # client_cert: <list or string>
            # client_cert_auth: <value in [disable, enable]>
            # cnid: <string>
            # dn: <string>
            # filter: <string>
            # group: <string>
            # group_filter: <string>
            # group_member_check: <value in [user-attr, group-object, posix-group-object]>
            ...
            # member_attr: <string>
            # obtain_user_info: <value in [disable, enable]>
            # password: <list or string>
            # password_attr: <string>
            # password_expiry_warning: <value in [disable, enable]>
            ...
            # source_port: <integer>
            # ssl_max_proto_version: <value in [TLSv1-1, TLSv1-2, SSLv3, ...]>
            # ssl_min_proto_version: <value in [default, TLSv1, TLSv1-1, ...]>
            # status_ttl: <integer>
            # tertiary_server: <string>
            # two_factor: <value in [disable, fortitoken-cloud]>
            ...
            # user_info_exchange_server: <list or string>
            # username: <string>
