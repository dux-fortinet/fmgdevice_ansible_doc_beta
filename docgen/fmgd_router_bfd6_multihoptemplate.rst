:source: fmgd_router_bfd6_multihoptemplate.py

:orphan:

.. _fmgd_router_bfd6_multihoptemplate:
...
.. raw:: html
 ...
 <li><span class="li-head">router_bfd6_multihoptemplate</span> - BFD IPv6 multi-hop template table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: BFD IPv6 multi-hop template table.
        fortinet.fortimanager.fmgd_router_bfd6_multihoptemplate:
