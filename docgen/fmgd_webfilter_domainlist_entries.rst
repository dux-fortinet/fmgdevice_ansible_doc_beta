:source: fmgd_webfilter_domainlist_entries.py

:orphan:

.. _fmgd_webfilter_domainlist_entries:
...
.. raw:: html
 ...
 <li><span class="li-head">webfilter_domainlist_entries</span> - Device vdom webfilter domain list entries <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom webfilter domain list entries
        fortinet.fmgdevice.fmgd_webfilter_domainlist_entries:
