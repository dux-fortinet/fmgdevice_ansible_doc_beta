:source: fmgd_switchcontroller_ptp_interfacepolicy.py

:orphan:

.. _fmgd_switchcontroller_ptp_interfacepolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_ptp_interfacepolicy</span> - PTP interface-policy configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">vlan</span> Ptp vlan. <span class="li-normal">type: list</span>
 <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 <div id="label5" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">vlan_pri</span> <b>(Alias name: vlan-pri)</b>  Configure ptp vlan priority (0 - 7, default = 4). <span class="li-normal">type: int</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: PTP interface-policy configuration.
        fortinet.fortimanager.fmgd_switchcontroller_ptp_interfacepolicy:
