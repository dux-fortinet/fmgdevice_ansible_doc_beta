:source: fmgd_icap_remoteservergroup.py

:orphan:

.. _fmgd_icap_remoteservergroup:
...
.. raw:: html
 ...
 <li><span class="li-head">icap_remoteservergroup</span> - Device vdom icap remote server group <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Device vdom icap remote server group
        fortinet.fmgdevice.fmgd_icap_remoteservergroup:
