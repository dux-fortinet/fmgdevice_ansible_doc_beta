:source: fmgd_log_syslogd_overridesetting.py

:orphan:

.. _fmgd_log_syslogd_overridesetting:
...
.. raw:: html
 ...
 <li><span class="li-head">log_syslogd_overridesetting</span> - Override settings for remote syslog server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Override settings for remote syslog server.
        fortinet.fortimanager.fmgd_log_syslogd_overridesetting:
