:source: fmgd_log_threatweight_geolocation.py

:orphan:

.. _fmgd_log_threatweight_geolocation:
...
.. raw:: html
 ...
 <li><span class="li-head">log_threatweight_geolocation</span> - Geolocation-based threat weight settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Geolocation-based threat weight settings.
        fortinet.fmgdevice.fmgd_log_threatweight_geolocation:
