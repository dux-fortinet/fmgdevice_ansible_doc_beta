...
.. raw:: html
 ...
 <li><span class="li-head">command_name</span> <b>(Alias name: command-name)</b>  Names of commands to be pushed to this fortiswitch device, as configured under config switch-controller custom-command. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">poe_detection_type</span> <b>(Alias name: poe-detection-type)</b>  Poe detection type for fortiswitch. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">allowed_vlans</span> <b>(Alias name: allowed-vlans)</b>  Configure switch port tagged vlans. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">vlan_name</span> <b>(Alias name: vlan-name)</b>  Dhcp snooping option 82 vlan. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">dsl_profile</span> <b>(Alias name: dsl-profile)</b>  Dsl policy configuration. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">interface_tags</span> <b>(Alias name: interface-tags)</b>  Tag(s) associated with the interface for various features including virtual port pool, dynamic port policy. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">lldp_profile</span> <b>(Alias name: lldp-profile)</b>  Lldp port tlv profile. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">port_policy</span> <b>(Alias name: port-policy)</b>  Switch controller dynamic port policy from available options. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">port_security_policy</span> <b>(Alias name: port-security-policy)</b>  Switch controller authentication policy to apply to this managed switch from available options. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">qos_policy</span> <b>(Alias name: qos-policy)</b>  Switch controller qos policy from available options. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">sample_direction</span> <b>(Alias name: sample-direction)</b>  Packet sampling direction. <span class="li-normal">type: str</span> <span class="li-normal">choices: [rx, tx, both]</span> 
 ...
 <li><span class="li-head">sflow_counter_interval</span> <b>(Alias name: sflow-counter-interval)</b>  Sflow sampling counter polling interval in seconds (0 - 255). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">storm_control_policy</span> <b>(Alias name: storm-control-policy)</b>  Switch controller storm control policy from available options. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">untagged_vlans</span> <b>(Alias name: untagged-vlans)</b>  Configure switch port untagged vlans. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">vlan</span> Assign switch ports to a vlan. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ptp_profile</span> <b>(Alias name: ptp-profile)</b>  Ptp profile configuration. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ip</span> Ipv4 address of the snmp manager (host). <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">switch_id</span> <b>(Alias name: switch-id)</b>  Managed-switch name. <span class="li-normal">type: str</span>
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Configure FortiSwitch devices that are managed by this FortiGate.
        fortinet.fortimanager.fmgd_switchcontroller_managedswitch:
