:source: fmgd_firewall_internetserviceextension_entry.py

:orphan:

.. _fmgd_firewall_internetserviceextension_entry:
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    tasks:
      - name: Entries added to the Internet Service extension database.
        fortinet.fortimanager.fmgd_firewall_internetserviceextension_entry:
